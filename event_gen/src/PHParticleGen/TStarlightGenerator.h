#ifndef __TSTARLIGHTGENERATOR_H__
#define __TSTARLIGHTGENERATOR_H__
...
class TStarlightGenerator : public TSingleParticleGenerator {

public:

  TStarlightGenerator(const char* name = "TStarlightGenerator",
			   const char* title = "TStarlightGenerator");

  virtual ~TStarlightGenerator();

  int OpenStarlightFile(const char *fname);
...
protected:
  ...
  ClassDef(TStarlightGenerator,0);              
};

#endif // __TSTARLIGHTGENERATOR_H__

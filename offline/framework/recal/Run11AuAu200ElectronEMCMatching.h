#ifndef __RUN11AUAU200ELECTRONEMCMATCHING_H__
#define __RUN11AUAU200ELECTRONEMCMATCHING_H__
...
class Run11AuAu200ElectronEMCMatching : public Recalibrator
{
public:
    Run11AuAu200ElectronEMCMatching(const std::string &name = "Run11AuAu200ElectronEMCMatching");
    virtual ~Run11AuAu200ElectronEMCMatching() {}  
...
#endif /* __RUN11AUAU200ELECTRONEMCMATCHING_H__ */

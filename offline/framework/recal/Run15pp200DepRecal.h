#ifndef __RUN15PP200DEPRECAL_H__
#define __RUN15PP200DEPRECAL_H__
...
class Run15pp200DepRecal : public Recalibrator
{
public:
    Run15pp200DepRecal(const std::string &name = "Run15pp200DepRecal");
    virtual ~Run15pp200DepRecal() {}  

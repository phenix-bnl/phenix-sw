#ifndef RUN15PPEMCMATCHING_H
#define RUN15PPEMCMATCHING_H
...
class Run15ppEMCMatching : public Recalibrator
{
 public:
  Run15ppEMCMatching(const std::string &name="Run15ppEMCMatching");
  virtual ~Run15ppEMCMatching() {}
 ...
 private:
  ...
  float finaldPhiSigmaParam_1[NCHARGE][NSECT][NZED];
  float finaldPhiSigmaParam_2[NCHARGE][NSECT][NZED];
  float finaldPhiSigmaParam_3[NCHARGE][NSECT][NZED];

  float initialdZMeanParam_0[NCHARGE][NSECT][NZED];
  float initialdZMeanParam_1[NCHARGE][NSECT][NZED];
  float initialdZMeanParam_2[NCHARGE][NSECT][NZED];
  float initialdZMeanParam_3[NCHARGE][NSECT][NZED];
  ...
  float initialdZSigmaParam_5[NCHARGE][NSECT][NZED];

  float finaldZMeanParam_0[NCHARGE][NSECT][NZED];
  float finaldZMeanParam_1[NCHARGE][NSECT][NZED];
  float finaldZMeanParam_2[NCHARGE][NSECT][NZED];
  ...
  float finaldZSigmaParam_3[NCHARGE][NSECT][NZED];
  float finaldZSigmaParam_4[NCHARGE][NSECT][NZED];
  float finaldZSigmaParam_5[NCHARGE][NSECT][NZED];

};

#endif // RUN15PPEMCMATCHING_H

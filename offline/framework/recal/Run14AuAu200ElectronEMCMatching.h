#ifndef __RUN14AUAU200ELECTRONEMCMATCHING_H__
#define __RUN14AUAU200ELECTRONEMCMATCHING_H__
...
class Run14AuAu200ElectronEMCMatching : public Recalibrator
{
public:
    Run14AuAu200ElectronEMCMatching(const std::string &name = "Run14AuAu200ElectronEMCMatching");
    virtual ~Run14AuAu200ElectronEMCMatching() {}  

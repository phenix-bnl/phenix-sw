#ifndef MATCHRECALRECO20GEVRUN16DAU_H
#define MATCHRECALRECO20GEVRUN16DAU_H
...
class MatchrecalReco20GeVRun16dAu : public Recalibrator
{
 public:
  MatchrecalReco20GeVRun16dAu(const std::string &name="MatchrecalReco20GeVRun16dAu");
  virtual ~MatchrecalReco20GeVRun16dAu() {}

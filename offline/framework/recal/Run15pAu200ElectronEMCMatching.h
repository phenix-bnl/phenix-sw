#ifndef __RUN15PAU200ELECTRONEMCMATCHING_H__
#define __RUN15PAU200ELECTRONEMCMATCHING_H__
...
class Run15pAu200ElectronEMCMatching : public Recalibrator
{
public:
    Run15pAu200ElectronEMCMatching(const std::string &name = "Run15pAu200ElectronEMCMatching");
    virtual ~Run15pAu200ElectronEMCMatching() {}  

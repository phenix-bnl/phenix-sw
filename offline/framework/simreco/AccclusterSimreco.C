...
AccclusterSimreco::AccclusterSimreco(const char *name, const int ver)
 : SubsysReco(name)
{
  cout<<"Call AccclusterSimreco()"<<endl;
  version = ver; 
}

int AccclusterSimreco::Init(PHCompositeNode* topNode)
{
  cout<<"Call AccclusterSimreco::Init()"<<endl;
...
int AccclusterSimreco::ResetEvent(PHCompositeNode *topNode)
{
  // cout<<"AccclusterSimreco::ResetEvent()"<<endl;
...
int AccclusterSimreco::process_event(PHCompositeNode* topNode)
{
  // cout<<"AccclusterSimreco::process_event()"<<endl;

...
PHCompositeNode*
PHNodeIOManager::read(PHCompositeNode* topNode, size_t requestedEvent, int flag)
{
  ...
  if (tree && readEventFromFile(requestedEvent,flag))
    {
      return topNode;
    }
  else
...
PHBoolean
PHNodeIOManager::readEventFromFile(size_t requestedEvent, int flag)
{

...
class PHFlag
{
 public:
  ...
  virtual const char *get_CharFlag(const std::string &flag) const;
  virtual const char *get_CharFlag(const std::string &name, const std::string &defaultval);
  ...
  virtual void remove_IntFlag(const std::string &name);
  virtual void remove_FloatFlag(const std::string &name);
  virtual void remove_DoubleFlag(const std::string &name);
  virtual void remove_CharFlag(const std::string &name);

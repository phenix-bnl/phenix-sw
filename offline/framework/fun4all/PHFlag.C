...
void PHFlag::remove_IntFlag(const string &name)
{
  intflag.erase(name);
}

void PHFlag::remove_FloatFlag(const string &name)
{
  floatflag.erase(name);
}

void PHFlag::remove_DoubleFlag(const string &name)
{
  doubleflag.erase(name);
}

void PHFlag::remove_CharFlag(const string &name)
{
  charflag.erase(name);
}

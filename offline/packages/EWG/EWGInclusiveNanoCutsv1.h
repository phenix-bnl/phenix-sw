#ifndef EWGINCLUSIVENANOCUTSV1_H
#define EWGINCLUSIVENANOCUTSV1_H
...
class EWGInclusiveNanoCutsv1 : public PHInclusiveNanoCuts {

public:

  EWGInclusiveNanoCutsv1();
  virtual ~EWGInclusiveNanoCutsv1() { }

  // These are necessary for all PHObjects:
  int  isValid() const {return(1);}
  void identify(std::ostream &os=std::cout) const {os << "identify yourself: EWGInclusiveNanoCutsv1 Object" << std::endl;}
...
protected:
  ...
  ClassDef(EWGInclusiveNanoCutsv1,1)

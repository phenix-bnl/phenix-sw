#ifndef __PHSNGLELECTRONV1_H
#define __PHSNGLELECTRONV1_H

#include "PHObject.h"

class PHSnglElectronv1 : public TObject
{
 public:
  PHSnglElectronv1();
  PHSnglElectronv1(PHSnglElectronv1*track);  
  virtual ~PHSnglElectronv1() {}
 ...
 protected:
  ...
  ClassDef(PHSnglElectronv1,1)
};

#endif /* PHHSNGLELECRONV1 */

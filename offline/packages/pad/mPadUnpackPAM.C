...
PHBoolean
mPadUnpackModule::callPAM(PHPointerList<PHNode> &nl) {
  long result;
  ...
  dPadDCMNode_t* n1 = static_cast<dPadDCMNode_t*>(nl[0]);
  dPadGeomNode_t* n2 = static_cast<dPadGeomNode_t*>(nl[1]);
  dPadNibbleGhitNode_t* n3 = static_cast<dPadNibbleGhitNode_t*>(nl[2]);
  dPadFEMParNode_t* n4 = static_cast<dPadFEMParNode_t*>(nl[3]);
  dPadRawNode_t* n5 = static_cast<dPadRawNode_t*>(nl[4]);

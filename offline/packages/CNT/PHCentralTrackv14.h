#ifndef __PHCENTRALTRACKV14_H
#define __PHCENTRALTRACKV14_H
...
class PHCentralTrackv14 : public PHCentralTrack
{
 public:
  PHCentralTrackv14(int fetch=0);
  PHCentralTrackv14(const PHCentralTrackv14&);
  PHCentralTrackv14& operator=(const PHCentralTrackv14&);
  virtual ~PHCentralTrackv14();
...
private:
  // Copy this to dest.
  void copyto(PHCentralTrackv14& dest) const;

  ClassDef(PHCentralTrackv14,1)
};

#endif /* __PHCENTRALTRACKV14_H */

#ifndef __PHCENTRALTRACKV20_H
#define __PHCENTRALTRACKV20_H
...
class PHCentralTrackv20 : public PHCentralTrack
{
 public:
  PHCentralTrackv20();
  PHCentralTrackv20(const PHCentralTrackv20&);
  PHCentralTrackv20& operator=(const PHCentralTrackv20&);
  virtual ~PHCentralTrackv20();
...
private:
  // Copy this to dest.
  void copyto(PHCentralTrackv20& dest) const;

  ClassDef(PHCentralTrackv20,1)
};

#endif /* __PHCENTRALTRACKV20_H */

#ifndef __PHCENTRALTRACKV7_H
#define __PHCENTRALTRACKV7_H
...
//                                 TKH 6-21-2002
//  This is the "v7" version that is made available to OnCal online
//  calibrations.
//                                 TKH 1-9-2003
//
...
class PHCentralTrackv7 : public PHCentralTrack
{
 public:
  PHCentralTrackv7(int fetch=0);
  virtual ~PHCentralTrackv7();
 ...
 protected:
  ...
  ClassDef(PHCentralTrackv7,1)
};

#endif /* __PHCENTRALTRACKV7_H */

#ifndef __PHCENTRALTRACKV1_H
#define __PHCENTRALTRACKV1_H
...
class PHCentralTrackv1 : public PHCentralTrack
{
 public:
  PHCentralTrackv1(int fetch=0);
  virtual ~PHCentralTrackv1();
 ...
 protected:
  ...
  ClassDef(PHCentralTrackv1,1)
};

#endif /* __PHCENTRALTRACKV1_H */

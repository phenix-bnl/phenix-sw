#ifndef __PHSNGLCENTRALTRACKV17_H_
#define __PHSNGLCENTRALTRACKV17_H_

#include "PHObject.h"
#include "PHSnglCentralTrack.h"

class PHSnglCentralTrackv17 : public PHSnglCentralTrack
{
 public:
  PHSnglCentralTrackv17();
  PHSnglCentralTrackv17(const PHSnglCentralTrack &track);  
  virtual ~PHSnglCentralTrackv17() {}
  ...
  void set_pmrpcx     (const float val) {pmrpcx     =val; return;}
  void set_pmrpcy     (const float val) {pmrpcy     =val; return;}
  void set_pmrpcz     (const float val) {pmrpcz     =val; return;}
  void set_pltof      (const float val) {pltof      =val; return;}
  void set_plemc      (const float val) {plemc      =val; return;}
  void set_plmrpc     (const float val) {plmrpc     =val; return;}
  ...
  void set_slat_mrpc  (const int   val) {slat_mrpc  =val; return;}
  void set_ttof_mrpc  (const float val) {ttof_mrpc  =val; return;}
  void set_ttofd_mrpc (const float val) {ttofd_mrpc =val; return;}
  void set_qtof_mrpc  (const float val) {qtof_mrpc  =val; return;}
  ...
  void set_mrpcid       (const short val) {mrpcid       = val; return;}
  ...
  void set_mrpcdphi     (const float val) {mrpcdphi      = val; return;}
  void set_mrpcdz       (const float val) {mrpcdz        = val; return;}
  ...
  float get_pmrpcx     () const  { return  pmrpcx      ;}
  float get_pmrpcy     () const  { return  pmrpcy      ;}
  float get_pmrpcz     () const  { return  pmrpcz      ;}
  float get_pltof      () const  { return  pltof       ;}
  float get_plemc      () const  { return  plemc       ;}
  float get_plmrpc     () const  { return  plmrpc      ;}
  ...
  int   get_slat_mrpc  () const  { return  slat_mrpc   ;}
  float get_ttof_mrpc  () const  { return  ttof_mrpc   ;}
  float get_ttofd_mrpc () const  { return  ttofd_mrpc  ;}
  float get_qtof_mrpc  () const  { return  qtof_mrpc   ;}
  ...
  short get_mrpcid      () const { return mrpcid ;}
  ...
  float get_mrpcdphi     () const { return mrpcdphi       ;}
  float get_mrpcdz       () const { return mrpcdz ;}
 ...
 protected:
  ...
  ClassDef(PHSnglCentralTrackv17,1)
};

#endif /* PHHSNGLCENTRALTRACKV17 */

#ifndef __PHSNGLCENTRALTRACKV16_H_
#define __PHSNGLCENTRALTRACKV16_H_

#include "PHObject.h"
#include "PHSnglCentralTrack.h"

// TOF.W added to v16 by C. Aidala 3/2008 for Run-08 p+p reconstruction 
// (Run-08 central arm configuration = Run-06 + TOF.W).
// Note that TOF.W uses same CNT variables as TOF.E.  Simply use different 
// get and set methods for TOF depending on arm.

class PHSnglCentralTrackv16 : public PHSnglCentralTrack
{
 public:
  PHSnglCentralTrackv16();
  PHSnglCentralTrackv16(const PHSnglCentralTrack &track);  
  virtual ~PHSnglCentralTrackv16() {}
  ...
  ///////////////////////
  // TOF.W methods, added to v16 by C. Aidala 3/2008, copied from v21
 ...
 protected:
  ...
  ClassDef(PHSnglCentralTrackv16,1)
};

#endif /* PHHSNGLCENTRALTRACKV16 */

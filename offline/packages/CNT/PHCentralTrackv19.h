#ifndef __PHCENTRALTRACKV19_H
#define __PHCENTRALTRACKV19_H
...
class PHCentralTrackv19 : public PHCentralTrack
{
 public:
  PHCentralTrackv19(int fetch=0);
  PHCentralTrackv19(const PHCentralTrackv19&);
  PHCentralTrackv19& operator=(const PHCentralTrackv19&);
  virtual ~PHCentralTrackv19();
...
private:
  // Copy this to dest.
  void copyto(PHCentralTrackv19& dest) const;

  ClassDef(PHCentralTrackv19,1)
};

#endif /* __PHCENTRALTRACKV19_H */

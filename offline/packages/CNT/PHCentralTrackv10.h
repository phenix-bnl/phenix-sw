#ifndef __PHCENTRALTRACKV10_H
#define __PHCENTRALTRACKV10_H
...
//                                 TKH 1-9-2003
//
//  This is the "v10" version that is the first candidate for offline
...
class PHCentralTrackv10 : public PHCentralTrack
{
 public:
  PHCentralTrackv10(int fetch=0);
  PHCentralTrackv10(const PHCentralTrackv10&);
  PHCentralTrackv10& operator=(const PHCentralTrackv10&);
  virtual ~PHCentralTrackv10();
...
private:
  // Copy this to dest.
  void copyto(PHCentralTrackv10& dest) const;
  ClassDef(PHCentralTrackv10,1)
};

#endif /* __PHCENTRALTRACKV10_H */

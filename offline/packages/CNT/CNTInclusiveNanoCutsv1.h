#ifndef CNTINCLUSIVENANOCUTSV1_H
#define CNTINCLUSIVENANOCUTSV1_H
...
*/
class CNTInclusiveNanoCutsv1 : public PHInclusiveNanoCuts {

public:

  CNTInclusiveNanoCutsv1();
  virtual ~CNTInclusiveNanoCutsv1() { }

  // These are necessary for all PHObjects:
  int  isValid() const {return(1);}
  void identify(std::ostream &os=std::cout) const {os << "identify yourself: CNTInclusiveNanoCutsv1 Object" << std::endl;}
...
protected:
  ...
  ClassDef(CNTInclusiveNanoCutsv1,1)

#ifndef __PHSNGLCENTRALTRACKV7_H_
#define __PHSNGLCENTRALTRACKV7_H_

#include "PHObject.h"
#include "PHSnglCentralTrack.h"

class PHSnglCentralTrackv7 : public PHSnglCentralTrack
{
 public:
  PHSnglCentralTrackv7();
  PHSnglCentralTrackv7(const PHSnglCentralTrackv7 &track);  
  virtual ~PHSnglCentralTrackv7() {}
 ...
 protected:
  ...
  ClassDef(PHSnglCentralTrackv7,1)
};

#endif /* PHHSNGLCENTRALTRACKV7 */

#ifndef __PHSNGLCENTRALTRACKV6_H_
#define __PHSNGLCENTRALTRACKV6_H_

#include "PHObject.h"
#include "PHSnglCentralTrack.h"

class PHSnglCentralTrackv6 : public PHSnglCentralTrack
{
 public:
  PHSnglCentralTrackv6();
  PHSnglCentralTrackv6(const PHSnglCentralTrackv6 &track);  
  virtual ~PHSnglCentralTrackv6() {}
  ...
  void set_tzrid	(const short val) {tzrid	= val; return;}
  void set_pcrid	(const short val) {pcrid	= val; return;}
  void set_ptzrx	(const float val) {ptzrx	= val; return;}
  void set_ptzry	(const float val) {ptzry	= val; return;}
  void set_ptzrz	(const float val) {ptzrz	= val; return;}
  void set_ppcrx	(const float val) {ppcrx	= val; return;}
  void set_ppcry	(const float val) {ppcry	= val; return;}
  void set_ppcrz	(const float val) {ppcrz	= val; return;}
  void set_tzrtof	(const float val) {tzrtof	= val; return;}
  void set_tzrslat	(const short val) {tzrslat	= val; return;}
  void set_tzreloss	(const float val) {tzreloss	= val; return;}
  void set_tzrx	        (const float val) {tzrx	= val; return;}
  void set_tzry	        (const float val) {tzry	= val; return;}
  void set_tzrz	        (const float val) {tzrz	= val; return;}
  void set_pcrtof	(const float val) {pcrtof	= val; return;}
  void set_pcrslat	(const short val) {pcrslat	= val; return;}
  void set_pcreloss	(const float val) {pcreloss	= val; return;}
  void set_pcrx	        (const float val) {pcrx	= val; return;}
  void set_pcry	        (const float val) {pcry	= val; return;}
  void set_pcrz	        (const float val) {pcrz	= val; return;}
  ...
  void set_pc1wid	(const float val) {pc1wid	= val; return;}
  void set_pc2wid	(const float val) {pc2wid	= val; return;}
  void set_pc3wid	(const float val) {pc3wid	= val; return;}
  ...
  short get_tzrid	() const { return tzrid	;}
  short get_pcrid	() const { return pcrid	;}
  float get_ptzrx	() const { return ptzrx	;}
  float get_ptzry	() const { return ptzry	;}
  float get_ptzrz	() const { return ptzrz	;}
  float get_ppcrx	() const { return ppcrx	;}
  float get_ppcry	() const { return ppcry	;}
  float get_ppcrz	() const { return ppcrz	;}
  float get_tzrtof	() const { return tzrtof	;}
  short get_tzrslat	() const { return tzrslat	;}
  float get_tzreloss	() const { return tzreloss	;}
  float get_tzrx	() const { return tzrx	;}
  float get_tzry	() const { return tzry	;}
  float get_tzrz	() const { return tzrz	;}
  float get_pcrtof	() const { return pcrtof	;}
  short get_pcrslat	() const { return pcrslat	;}
  float get_pcreloss	() const { return pcreloss	;}
  float get_pcrx	() const { return pcrx	;}
  float get_pcry	() const { return pcry	;}
  float get_pcrz	() const { return pcrz	;}
  ...
  float get_pc1wid	() const { return pc1wid	;}
  float get_pc2wid	() const { return pc2wid	;}
  float get_pc3wid	() const { return pc3wid	;}
 ...
 protected:
  ...
  ClassDef(PHSnglCentralTrackv6,1)
};

#endif /* PHHSNGLCENTRALTRACKV6 */

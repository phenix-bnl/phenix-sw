#ifndef __PHSNGLCENTRALTRACKV13_H_
#define __PHSNGLCENTRALTRACKV13_H_

#include "PHObject.h"
#include "PHSnglCentralTrack.h"

class PHSnglCentralTrackv13 : public PHSnglCentralTrack
{
 public:
  PHSnglCentralTrackv13();
  PHSnglCentralTrackv13(const PHSnglCentralTrack &track);  
  virtual ~PHSnglCentralTrackv13() {}
  ...
  void set_aerph1       (const float val) {aerph1       = val; return;}
  void set_aerph2       (const float val) {aerph2       = val; return;}
  void set_aert1        (const float val) {aert1        = val; return;}
  void set_aert2        (const float val) {aert2        = val; return;}
  void set_aernpe       (const float val) {aernpe       = val; return;}
  void set_aerstatus    (const short val) {aerstatus    = val; return;}
  ...
  void set_tecde        (const float val) {tecde        = val; return;}
  void set_tecde06      (const float val) {tecde06      = val; return;}
  void set_tectrklen    (const float val) {tectrklen    = val; return;}
  void set_tecnde       (const short val) {tecnde       = val; return;}
  void set_tecnhit100   (const short val) {tecnhit100   = val; return;}
  void set_tecnhit200   (const short val) {tecnhit200   = val; return;}
  void set_tecnhit50    (const short val) {tecnhit50    = val; return;}
  void set_tecwtb       (const float val) {tecwtb       = val; return;}
  void set_tecwtbsq     (const float val) {tecwtbsq     = val; return;}
  ...
  float get_aerph1      () const { return aerph1        ;}
  float get_aerph2      () const { return aerph2        ;}
  float get_aert1       () const { return aert1 ;}
  float get_aert2       () const { return aert2 ;}
  float get_aernpe      () const { return aernpe        ;}
  short get_aerstatus   () const { return aerstatus     ;}
  ...
  float get_tecde       () const { return tecde;}
  float get_tecde06     () const { return tecde06;}
  float get_tectrklen   () const { return tectrklen;}
  short get_tecnde      () const { return tecnde;}
  short get_tecnhit100  () const { return tecnhit100;}
  short get_tecnhit200  () const { return tecnhit200;}
  short get_tecnhit50   () const { return tecnhit50;}
  float get_tecwtb      () const { return tecwtb;}
  float get_tecwtbsq    () const { return tecwtbsq;}
 ...
 protected:
  ...
  ClassDef(PHSnglCentralTrackv13,1)
};

#endif /* PHHSNGLCENTRALTRACKV13 */

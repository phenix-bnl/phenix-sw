#ifndef __PHCENTRALTRACKV23_H
#define __PHCENTRALTRACKV23_H
...
class PHCentralTrackv23 : public PHCentralTrack
{
 public:
  PHCentralTrackv23(int fetch=0);
  PHCentralTrackv23(const PHCentralTrackv23&);
  PHCentralTrackv23& operator=(const PHCentralTrackv23&);
  virtual ~PHCentralTrackv23();
...
private:
  // Copy this to dest.
  void copyto(PHCentralTrackv23& dest) const;

  ClassDef(PHCentralTrackv23,1)
};

#endif /* __PHCENTRALTRACKV23_H */

#ifndef __PHCENTRALTRACKV16_H
#define __PHCENTRALTRACKV16_H
...
class PHCentralTrackv16 : public PHCentralTrack
{
 public:
  PHCentralTrackv16(int fetch=0);
  PHCentralTrackv16(const PHCentralTrackv16&);
  PHCentralTrackv16& operator=(const PHCentralTrackv16&);
  virtual ~PHCentralTrackv16();
...
private:
  // Copy this to dest.
  void copyto(PHCentralTrackv16& dest) const;

  ClassDef(PHCentralTrackv16,1)
};

#endif /* __PHCENTRALTRACKV16_H */

#ifndef __PHCENTRALTRACKV17_H
#define __PHCENTRALTRACKV17_H
...
class PHCentralTrackv17 : public PHCentralTrack
{
 public:
  PHCentralTrackv17(int fetch=0);
  PHCentralTrackv17(const PHCentralTrackv17&);
  PHCentralTrackv17& operator=(const PHCentralTrackv17&);
  virtual ~PHCentralTrackv17();
...
private:
  // Copy this to dest.
  void copyto(PHCentralTrackv17& dest) const;

  ClassDef(PHCentralTrackv17,1)
};

#endif /* __PHCENTRALTRACKV17_H */

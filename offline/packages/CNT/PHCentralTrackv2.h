#ifndef __PHCENTRALTRACKV2_H
#define __PHCENTRALTRACKV2_H
...
//                                 TKH 3-7-2002
//
//  This is the "v2" version which is the candidate for CNT tracks
...
class PHCentralTrackv2 : public PHCentralTrack
{
 public:
  PHCentralTrackv2(int fetch=0);
  virtual ~PHCentralTrackv2();
  ...
  float determine_PIDtof(const unsigned int itrk, const float m2Centroid) const;
  float determine_PIDemc(const unsigned int itrk, const float m2Centroid) const;
 ...
 protected:
  ...
  ClassDef(PHCentralTrackv2,1)
};

#endif /* __PHCENTRALTRACKV2_H */

#ifndef __PHSNGLCENTRALTRACKV5_H_
#define __PHSNGLCENTRALTRACKV5_H_

#include "PHObject.h"

class PHSnglCentralTrackv5 : public TObject
{
 public:
  PHSnglCentralTrackv5();
  PHSnglCentralTrackv5(const PHSnglCentralTrackv5 &track);  
  virtual ~PHSnglCentralTrackv5() {}
 ...
 protected:
  ...
  ClassDef(PHSnglCentralTrackv5,1)
};

#endif /* PHHSNGLCENTRALTRACKV5 */

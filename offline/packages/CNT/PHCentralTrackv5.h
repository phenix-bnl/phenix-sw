#ifndef __PHCENTRALTRACKV5_H
#define __PHCENTRALTRACKV5_H
...
//                                 TKH 4-17-2002
//
//  This is the "v5" version which is the candidate for CNT tracks
...
class PHCentralTrackv5 : public PHCentralTrack
{
 public:
  PHCentralTrackv5(int fetch=0);
  virtual ~PHCentralTrackv5();
 ...
 protected:
  ...
  ClassDef(PHCentralTrackv5,1)
};

#endif /* __PHCENTRALTRACKV5_H */

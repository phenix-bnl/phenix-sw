#ifndef __PHCENTRALTRACKV3_H
#define __PHCENTRALTRACKV3_H
...
//                                 TKH 3-7-2002
//
//  This is the "v3" version which is the candidate for CNT tracks
...
class PHCentralTrackv3 : public PHCentralTrack
{
 public:
  PHCentralTrackv3(int fetch=0);
  virtual ~PHCentralTrackv3();
 ...
 protected:
  ...
  ClassDef(PHCentralTrackv3,1)
};

#endif /* __PHCENTRALTRACKV3_H */

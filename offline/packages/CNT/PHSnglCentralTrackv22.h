#ifndef __PHSNGLCENTRALTRACKV22_H_
#define __PHSNGLCENTRALTRACKV22_H_

#include "PHObject.h"
#include "PHSnglCentralTrack.h"

class PHSnglCentralTrackv22 : public PHSnglCentralTrack
{
 public:
  PHSnglCentralTrackv22();
  PHSnglCentralTrackv22(const PHSnglCentralTrack &track);  
  virtual ~PHSnglCentralTrackv22() {}

  void identify(std::ostream &os=std::cout) const;


  ///////////////////////////////////////
  // This version 22 is originally inherited from v17, but combined the update of v19 and v21. Since v22 is for Run7 and sensitive to disk space, we also have to remove several variables and combine some others, such as put TOF east/west into same space, but still with two different methods.
 ...
 protected:
  ...
  ClassDef(PHSnglCentralTrackv22,1)
};

#endif /* PHHSNGLCENTRALTRACKV22 */

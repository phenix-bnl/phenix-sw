#ifndef __PHCENTRALTRACKV9_H
#define __PHCENTRALTRACKV9_H
...
class PHCentralTrackv9 : public PHCentralTrack
{
 public:
  PHCentralTrackv9(int fetch=0);
  virtual ~PHCentralTrackv9();
 ...
 protected:
  ...
  ClassDef(PHCentralTrackv9,1)
};

#endif /* __PHCENTRALTRACKV9_H */

#ifndef __PHCENTRALTRACKV24_H
#define __PHCENTRALTRACKV24_H
...
class PHCentralTrackv24 : public PHCentralTrack
{
 public:
  PHCentralTrackv24(int fetch=0);
  PHCentralTrackv24(const PHCentralTrackv24&);
  PHCentralTrackv24& operator=(const PHCentralTrackv24&);
  virtual ~PHCentralTrackv24();
...
private:
  // Copy this to dest.
  void copyto(PHCentralTrackv24& dest) const;

  ClassDef(PHCentralTrackv24,1)
};

#endif /* __PHCENTRALTRACKV24_H */

#ifndef __PHCENTRALTRACKV13_H
#define __PHCENTRALTRACKV13_H
...
class PHCentralTrackv13 : public PHCentralTrack
{
 public:
  PHCentralTrackv13(int fetch=0);
  PHCentralTrackv13(const PHCentralTrackv13&);
  PHCentralTrackv13& operator=(const PHCentralTrackv13&);
  virtual ~PHCentralTrackv13();
...
private:
  // Copy this to dest.
  void copyto(PHCentralTrackv13& dest) const;

  ClassDef(PHCentralTrackv13,1)
};

#endif /* __PHCENTRALTRACKV13_H */

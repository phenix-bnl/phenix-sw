#ifndef __PHCENTRALTRACKV12_H
#define __PHCENTRALTRACKV12_H
...
//                                 TKH 3-7-2002
//
//  This is the "v12" version which is the candidate for CNT tracks
...
class PHCentralTrackv12 : public PHCentralTrack
{
 public:
  PHCentralTrackv12(int fetch=0);
  PHCentralTrackv12(const PHCentralTrackv12&);
  PHCentralTrackv12& operator=(const PHCentralTrackv12&);
  virtual ~PHCentralTrackv12();
...
private:
  // Copy this to dest.
  void copyto(PHCentralTrackv12& dest) const;

  ClassDef(PHCentralTrackv12,1)
};

#endif /* __PHCENTRALTRACKV12_H */

#include "CNTInclusiveNanoCutsv1.h"
...
ClassImp(CNTInclusiveNanoCutsv1)

using namespace std;

typedef PHIODataNode<PHGlobal> PHGlobalNode_t;

CNTInclusiveNanoCutsv1::CNTInclusiveNanoCutsv1() {
 Reset();
}

void CNTInclusiveNanoCutsv1::Reset() {
...
void CNTInclusiveNanoCutsv1::Initialize(PHCompositeNode* topnode) {
...
PHBoolean CNTInclusiveNanoCutsv1::CentralTrackOK(PHCentralTrack* php, const unsigned int itrk) {

  //cout << "Central Track cutting routine..." << endl;

  // sanity check itrk is unsigned int and therefore always > 0
...
PHBoolean CNTInclusiveNanoCutsv1::GlobalOK(PHCompositeNode* topNode) {

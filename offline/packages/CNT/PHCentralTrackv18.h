#ifndef __PHCENTRALTRACKV18_H
#define __PHCENTRALTRACKV18_H
...
class PHCentralTrackv18 : public PHCentralTrack
{
 public:
  PHCentralTrackv18(int fetch=0);
  PHCentralTrackv18(const PHCentralTrackv18&);
  PHCentralTrackv18& operator=(const PHCentralTrackv18&);
  virtual ~PHCentralTrackv18();
...
private:
  // Copy this to dest.
  void copyto(PHCentralTrackv18& dest) const;

  ClassDef(PHCentralTrackv18,1)
};

#endif /* __PHCENTRALTRACKV18_H */

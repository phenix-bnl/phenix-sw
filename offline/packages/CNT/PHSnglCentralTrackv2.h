#ifndef __PHSNGLCENTRALTRACKV2_H_
#define __PHSNGLCENTRALTRACKV2_H_

#include "PHObject.h"

class PHSnglCentralTrackv2 : public TObject
{
 public:
  PHSnglCentralTrackv2();
  PHSnglCentralTrackv2(const PHSnglCentralTrackv2 &track);  
  virtual ~PHSnglCentralTrackv2() {}
 ...
 protected:
  ...
  ClassDef(PHSnglCentralTrackv2,1)
};

#endif /* PHHSNGLCENTRALTRACKV2 */

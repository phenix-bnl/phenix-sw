...
//_______________________________________
TRpcTrk_v2::TRpcTrk_v2(const Key& key, UShort_t arm, UShort_t index) :
  TRpcTrk(key),
  _arm(arm),
  _index(index),
  _chi_square(0),
...
//_______________________________________
TRpcTrk_v2::TRpcTrk_v2(const TRpcTrk* base_ptr) :
  TRpcTrk(*base_ptr),
...
//_______________________________________
TRpcTrk_v2::TRpcTrk_v2(const TRpcTrk& base_ref) :
  TRpcTrk(base_ref),
...
//_______________________________________
void TRpcTrk_v2::print(std::ostream& os, bool max) const
{

#ifndef __TRpcTrk_v3_H__
#define __TRpcTrk_v3_H__
...
class TRpcTrk_v3 : public TRpcTrk
{
 ...
 public:
  ...
  //! constructor 
  TRpcTrk_v3(const Key&, 
	     UShort_t arm, 
	     UShort_t index);

  //! constructor 
  TRpcTrk_v3(const TRpcTrk* base_ptr);

  //! constructor 
  TRpcTrk_v3(const TRpcTrk& base_ref);
  ...
  */
  ...
  //! Store extropolated hit positions
  //! From the track
  virtual void set_trk_extrapolated_hit_x1( double hitx ) { _extrap_trk_hit_x1 = hitx; }
  virtual double get_trk_extrapolated_hit_x1() const { return _extrap_trk_hit_x1; }
  virtual void set_trk_extrapolated_hit_y1( double hity ) { _extrap_trk_hit_y1 = hity; }
  virtual double get_trk_extrapolated_hit_y1() const { return _extrap_trk_hit_y1; }
  //! From the vertex
  virtual void set_trk_vtx_extrapolated_hit_x1( double hitx ) { _extrap_vtx_hit_x1 = hitx; }
  virtual double get_trk_vtx_extrapolated_hit_x1() const { return _extrap_vtx_hit_y1; }
  virtual void set_trk_vtx_extrapolated_hit_y1( double hity ) { _extrap_vtx_hit_y1 = hity; }
  virtual double get_trk_vtx_extrapolated_hit_y1() const { return _extrap_vtx_hit_y1; }
  
  //! DCA from track to RPC
  virtual void set_dca_trk1( double dca ) { _dca_trk1 = dca; }
  virtual double get_dca_trk1() const { return _dca_trk1; }
  virtual void set_rpcclus1time( double clustime ) { _rpc_clus1_time = clustime; }
  virtual double get_rpcclus1time() const { return _rpc_clus1_time; }

  //! DCA from vertex to RPC
  virtual void set_dca_trk_vtx1( double dca ) { _dca_trk_vtx1 = dca; }
  virtual double get_dca_trk_vtx1() const { return _dca_trk_vtx1; }
  virtual void set_rpcclus1time_vtx( double clustime ) { _rpc_clus1_vtx_time = clustime; }
  virtual double get_rpcclus1time_vtx() const { return _rpc_clus1_vtx_time; }
  ...
  //! extrapolatedhits (RPC1)
  double _extrap_trk_hit_x1;
  double _extrap_trk_hit_y1;
  double _extrap_vtx_hit_x1;
  double _extrap_vtx_hit_y1;
  
  //! RPC-DCA variables (RPC1)
  double _dca_trk1;
  double _dca_trk_vtx1;
  double _rpc_clus1_time;
  double _rpc_clus1_vtx_time;

  ClassDef(TRpcTrk_v3,2)
};

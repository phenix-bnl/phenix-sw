...

{
  ...
  gSystem->Load("/home/phnxdc/lib0720/install/lib/libphdisplay.so");
  gSystem->Load("/home/phnxdc/lib0720/install/lib/libphgui.so");
  gSystem->Load("/home/phnxdc/lib0720/install/lib/libdchdisplay.so");
  //gSystem->Load("/phenix/workarea/federica/co/install/lib/libpadisplay.so");
  ...
  PHString prdfInFile ="/export/bigdisk/dcm_data/rc/EVENTDATA_X01_0000007213_00.PRDFF";
...
//************************************************************
 ...
 topNode->addNode(prdfEventNode);
  ...
  if (mainIter.findFirst("PHDataNode","PRDF")) {
    cout << "EVEMT found "<< endl;
  }
  ...
  gPhenix->GetDisplay()->AddSubsystem(new PhDchDisplay("Dch-Display","Dch-Display"));

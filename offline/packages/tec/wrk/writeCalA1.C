...
//   char* location = "calib.tec.tecgain_geant0";
   ...
   TCO->setDescription("TEC Relative Wire-by-Wire Calibration Constants");

// Set geant calibration constants to 1.0
   PHBoolean status1 = TCO->FetchFromFile();
// Get calibration constants from a file
//   PHBoolean status1 = TCO->FetchRelGainFromFile("tecrelgain_database.txt");
// Hot wire gains zeroed in this file
   PHBoolean status1 = TCO->FetchRelGainFromFile("tecrelgain_database_0.txt");

void bbcResp(Int_t maxEvents=3, Int_t PRDFverbose=1, const char *fname="/phenix/data02/rhphemds/pisatest/PISACent10Hijing.root")
{
  //
  ...
  while (kevent < maxEvents) {
    ...
    cout << i << " " << dBbcRaw->get_Adc(i) << " " << dBbcRaw->get_Tdc0(i) << endl; 
    }

...
//_____________________________________________________________________
TMutTrk_v3::TMutTrk_v3(const Key& key,
  UShort_t arm,
  UShort_t octant,
  UShort_t index) :
  TMutTrk(key),
...
//_____________________________________________________________________
TMutTrk_v3::TMutTrk_v3(const TMutTrk* base_ptr) :
  TMutTrk(*base_ptr),
...
//_____________________________________________________________________
TMutTrk_v3::TMutTrk_v3(const TMutTrk& base_ref) :
  TMutTrk(base_ref),
...
//_____________________________________________________________________
void TMutTrk_v3::print(std::ostream& os, bool max) const
{
...
//_____________________________________________________________________
double TMutTrk_v3::get_w_chi_square_pdf() const 
{ 
  int ndf( get_ndf() );
...
//_____________________________________________________________________
double TMutTrk_v3::get_r_chi_square_pdf() const 
{ 
  int ndf( get_ndf() );

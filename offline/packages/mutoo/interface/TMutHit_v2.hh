#ifndef TMutHit_v2_hh
#define TMutHit_v2_hh
...
class TMutHit_v2 :  public TMutHit
{
public:

  TMutHit_v2();

  TMutHit_v2(const Key& key,
	  UShort_t arm,
	  UShort_t station,
	  UShort_t octant,
  ...
  //
  TMutHit_v2(const TMutHit* base_ptr);
  TMutHit_v2(const TMutHit& base_ref);

// $Id: TMutCoord_v2.cxx,v 1.9 2011/12/29 20:19:29 slash Exp $

#include "TMutCoord_v2.hh"

ClassImp(TMutCoord_v2)  
  
TMutCoord_v2::TMutCoord_v2() : 
  _arm(0),
  _station(0),
  _octant(0),
  _half_octant(0),
...
TMutCoord_v2::TMutCoord_v2(const Key& key,       
			   UShort_t arm,         
			   UShort_t station,     
			   UShort_t octant,      
...
TMutCoord_v2::TMutCoord_v2(const TMutCoord* base_ptr) :
  TMutCoord(*base_ptr),
...
TMutCoord_v2::TMutCoord_v2(const TMutCoord& base_ref) :
  TMutCoord(base_ref),
...
void TMutCoord_v2::print(std::ostream& os) const {
  ...
  os << "peak_strip: " << get_peak_strip() << " q_peak: " << _q_peak << " q_tot: " << _q_tot << std::endl;
  os << " w: " << _w << std::endl;
  os << " w error: " << _error << std::endl;
  MUTOO::PRINT(os,"**");
}

PHLine TMutCoord_v2::get_coord() const
{
...
PHPoint TMutCoord_v2::get_coord_end() const
{
  // No BOUNDS_CHECK here because this
  // is not part of the public interface
  //
...
PHPoint TMutCoord_v2::get_coord_midpoint() const
{
  // No BOUNDS_CHECK here because this
  // is not part of the public interface
  //
...
PHPoint TMutCoord_v2::get_coord_begin() const
{
  // No BOUNDS_CHECK here because this
  // is not part of the public interface
  //
...
double TMutCoord_v2::get_mean_z() const
{
  return 0.5*(_point_1[2] + _point_2[2]);
}

void TMutCoord_v2::set_coord(const PHLine& line) 
{

...
#ifndef __TMCPRIMARY_V2H__
#define __TMCPRIMARY_V2H__
...
class TMCPrimary_v2 : public TMCPrimary
{
  
 public:

  TMCPrimary_v2();
  TMCPrimary_v2(const Key& key, UShort_t index);
  TMCPrimary_v2(const TMCPrimary*);  
  TMCPrimary_v2(const TMCPrimary&);
  virtual ~TMCPrimary_v2(){;}
...
private:	
  ...
  ClassDef(TMCPrimary_v2,1)
};
		

		
#endif /* __TMCPRIMARY_V2H__*/

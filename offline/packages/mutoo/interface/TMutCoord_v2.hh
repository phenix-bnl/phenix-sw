// $Id: TMutCoord_v2.hh,v 1.7 2011/12/29 20:19:29 slash Exp $
...
#ifndef __TMUTCOORD_V2H__
#define __TMUTCOORD_V2H__
...
class TMutCoord_v2 : public TMutCoord
{
 ...
 public:
  ...
  TMutCoord_v2(const TMutCoord& base_ref);

  TMutCoord_v2(const TMutCoord* base_ptr);

  virtual ~TMutCoord_v2(){;}
 ...
 private:	
  ...
  ClassDef(TMutCoord_v2,1)
};

		
#endif /* __TMUTCOORD_V2H__*/

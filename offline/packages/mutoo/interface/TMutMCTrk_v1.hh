...
#ifndef __TMUTMCTRK_V1H__
#define __TMUTMCTRK_V1H__
...
class TMutMCTrk_v1 : public TMutMCTrk
{
 ...
 public:
  ...
  TMutMCTrk_v1(const Key& key, UShort_t arm, UShort_t index);

  TMutMCTrk_v1(const TMutMCTrk*);  
  TMutMCTrk_v1(const TMutMCTrk&);

  virtual ~TMutMCTrk_v1(){;}
...
private:	
  ...
  ClassDef(TMutMCTrk_v1,1)
};
		
#endif /* __TMutMCTrk_V1H__*/

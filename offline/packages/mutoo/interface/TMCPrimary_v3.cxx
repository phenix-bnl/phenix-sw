...
ClassImp(TMCPrimary_v3);

/*! default constructor */
TMCPrimary_v3::TMCPrimary_v3() :   
  _index(0),
  _file_key(0),
  _pisa_process_id(0),
  _pid(0),
...
TMCPrimary_v3::TMCPrimary_v3(const Key& key, 
			     UShort_t index) :
  TMCPrimary(key), 
  _index(index),
  _file_key(0),
...
TMCPrimary_v3::TMCPrimary_v3(const TMCPrimary* base_ptr):
  TMCPrimary(*base_ptr),
...
TMCPrimary_v3::TMCPrimary_v3(const TMCPrimary& base_ref):
  TMCPrimary(base_ref),
...
void TMCPrimary_v3::print(std::ostream& os) const {		       

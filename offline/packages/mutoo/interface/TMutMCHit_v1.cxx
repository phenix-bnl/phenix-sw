#include <MUTOO.h>
#include <TMutMCHit_v1.hh>

ClassImp(TMutMCHit_v1)

/*! default constructor */
TMutMCHit_v1::TMutMCHit_v1() : _arm(0),
			       _station(0),
			       _octant(0),
			       _half_octant(0),
			       _gap(0),
...
TMutMCHit_v1::TMutMCHit_v1(const Key& key, 
		     UShort_t arm, 
		     UShort_t station, 
		     UShort_t octant, 
...
TMutMCHit_v1::TMutMCHit_v1(const TMutMCHit* base_ptr) : 
  TMutMCHit(*base_ptr),
...
TMutMCHit_v1::TMutMCHit_v1(const TMutMCHit& base_ref) : 
  TMutMCHit(base_ref),
...
void TMutMCHit_v1::print(std::ostream& os) const {		       

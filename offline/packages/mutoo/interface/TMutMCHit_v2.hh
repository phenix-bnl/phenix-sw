...
#ifndef __TMUTMCHIT_V2_H__
#define __TMUTMCHIT_V2_H__
...
class TMutMCHit_v2 : public TMutMCHit
{
...
public:
  ...
  TMutMCHit_v2(const Key& key, UShort_t arm, UShort_t station, UShort_t octant,
            UShort_t half_octant, UShort_t gap, UShort_t index);

  TMutMCHit_v2(const TMutMCHit* base_ptr);
  TMutMCHit_v2(const TMutMCHit& base_ref);

  virtual ~TMutMCHit_v2() {;}
  ...
  const strip_list* get_strip_list() const {return &_strip_list;}
...
private:	
  ...
  ClassDef(TMutMCHit_v2,1)
};

#endif /* __TMutMCHit_V2_H__*/

...
ClassImp(TMutGapCoord_v2)

TMutGapCoord_v2::TMutGapCoord_v2() : 
  _arm(0),
  _station(0),
  _octant(0),
  _half_octant(0),
...
TMutGapCoord_v2::TMutGapCoord_v2(const Key& key,       
				 UShort_t arm,         
				 UShort_t station,     
				 UShort_t octant,      
...
TMutGapCoord_v2::TMutGapCoord_v2(const TMutGapCoord* base_ptr) : 
  ...
  _charge_corr(base_ptr->get_charge_corr())
{
  set_coord(base_ptr->get_coord());
}

TMutGapCoord_v2::TMutGapCoord_v2(const TMutGapCoord& base_ref) : 
  ...
  _charge_corr(base_ref.get_charge_corr())
{
  set_coord(base_ref.get_coord());
}

void TMutGapCoord_v2::print(std::ostream& os) const {
  ...
  os << " Charge-match correction: " << _charge_corr << std::endl;
  MUTOO::PRINT(os,"**");
}

PHVector TMutGapCoord_v2::get_anode_direction() const {

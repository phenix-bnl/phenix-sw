...
#ifndef __TMUTMCTRK_V2H__
#define __TMUTMCTRK_V2H__
...
class TMutMCTrk_v2 : public TMutMCTrk
{
 ...
 public:
  ...
  TMutMCTrk_v2(const Key& key, UShort_t arm, UShort_t index);

  TMutMCTrk_v2(const TMutMCTrk*);  

  TMutMCTrk_v2(const TMutMCTrk&);

  virtual ~TMutMCTrk_v2(){;}
...
private:	
  ...
  ClassDef(TMutMCTrk_v2,1)
};
		
#endif /* __TMutMCTrk_V2H__*/

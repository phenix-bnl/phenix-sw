// $Id: TMutClus_v2.cxx,v 1.5 2011/12/29 20:19:29 slash Exp $

/*!
   \file    TMutClus_v2.cxx
...
#include<cmath>
#include<MUTOO.h>
#include<TMutClus_v2.hh>
#include<TMutHitMap.h>
#include<PHConstKeyIterator.h>
#include<TMutGeo.h>

ClassImp(TMutClus_v2)
using namespace std;

//________________________________________________________
TMutClus_v2::TMutClus_v2() : 
  _arm(0),
  _station(0),
  _octant(0),
  _half_octant(0),
...
//________________________________________________________
TMutClus_v2::TMutClus_v2(const TMutClus* base_ptr) :       
  TMutClus(*base_ptr), 
...
//________________________________________________________
TMutClus_v2::TMutClus_v2(const TMutClus& base_ref) :       
  TMutClus(base_ref), 
...
//________________________________________________________
void TMutClus_v2::print(ostream& os) const 
{
  using namespace std;

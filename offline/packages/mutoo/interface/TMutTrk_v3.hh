...
#ifndef __TMUTTRK_V3H__
#define __TMUTTRK_V3H__
...
class TMutTrk_v3 : public TMutTrk
{
 ...
 public:
  ...
  TMutTrk_v3(const Key&, 
	     UShort_t arm, 
	     UShort_t octant,
	     UShort_t index);

  TMutTrk_v3(const TMutTrk* base_ptr);
  TMutTrk_v3(const TMutTrk& base_ref);
...
private:	
  ...
  */
  ...
  ClassDef(TMutTrk_v3,1)
};
  
#endif /* __TMUTTRK_V3H__*/

// $Id: TMutMCTrk_v3.cxx,v 1.7 2011/12/29 20:19:31 slash Exp $

#include <MUTOO.h>
#include <TMutMCTrk_v3.hh>
#include <TMutTrkMap.h>
#include <TMutMCHitMap.h>
#include <TMutCoordMap.h>
#include <bitset>

ClassImp(TMutMCTrk_v3);

TMutMCTrk_v3::TMutMCTrk_v3() :   
  _arm(0),
  _index(0),
  _file_key(0),
  _track_id(0),
...
TMutMCTrk_v3::TMutMCTrk_v3(const Key& key, 
			   UShort_t arm, 
			   UShort_t index) :
  TMutMCTrk(key), 
  _arm(arm), 
...
TMutMCTrk_v3::TMutMCTrk_v3(const TMutMCTrk* base_ptr):
  TMutMCTrk(*base_ptr),
...
TMutMCTrk_v3::TMutMCTrk_v3(const TMutMCTrk& base_ref):
  TMutMCTrk(base_ref),
...
void TMutMCTrk_v3::print(std::ostream& os) const {		       
  MUTOO::PRINT(os,GetName());
  os << " arm: " << _arm
     << " index: " << _index << std::endl;
  os << " track id: " << _track_id << " particle id: " << _pid << " parent track id: " << _parent_track_id<<" parent id : " << _parent_id << std::endl;

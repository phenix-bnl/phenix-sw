// $Id: TMutMCTrk_v4.cxx,v 1.3 2011/12/29 20:19:31 slash Exp $

#include <MUTOO.h>
#include <TMutMCTrk_v4.hh>
#include <TMutTrkMap.h>
#include <TMutMCHitMap.h>
#include <TMutCoordMap.h>
#include <bitset>

ClassImp(TMutMCTrk_v4);

TMutMCTrk_v4::TMutMCTrk_v4() :   
  _arm(0),
  _index(0),
  _file_key(0),
  _track_id(0),
...
TMutMCTrk_v4::TMutMCTrk_v4(const Key& key, 
			   UShort_t arm, 
			   UShort_t index) :
  TMutMCTrk(key), 
  _arm(arm), 
...
TMutMCTrk_v4::TMutMCTrk_v4(const TMutMCTrk* base_ptr):
  TMutMCTrk(*base_ptr),
...
TMutMCTrk_v4::TMutMCTrk_v4(const TMutMCTrk& base_ref):
  TMutMCTrk(base_ref),
...
void TMutMCTrk_v4::print(std::ostream& os) const {		       

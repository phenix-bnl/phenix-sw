...
#ifndef __TMUTMCTRK_V4H__
#define __TMUTMCTRK_V4H__
...
class TMutMCTrk_v4 : public TMutMCTrk
{
 ...
 public:
  ...
  TMutMCTrk_v4(const Key& key, UShort_t arm, UShort_t index);

  TMutMCTrk_v4(const TMutMCTrk*);  

  TMutMCTrk_v4(const TMutMCTrk&);

  virtual ~TMutMCTrk_v4(){;}
...
private:	
  ...
  ClassDef(TMutMCTrk_v4,1)
};
		
#endif /* __TMutMCTrk_V4H__*/

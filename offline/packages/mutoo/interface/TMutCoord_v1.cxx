// $Id: TMutCoord_v1.cxx,v 1.10 2011/12/29 20:19:29 slash Exp $

#include "TMutCoord_v1.hh"

ClassImp(TMutCoord_v1)  
  
TMutCoord_v1::TMutCoord_v1() : 
  _arm(0),
  _station(0),
  _octant(0),
  _half_octant(0),
...
TMutCoord_v1::TMutCoord_v1(const Key& key,       
			   UShort_t arm,         
			   UShort_t station,     
			   UShort_t octant,      
...
TMutCoord_v1::TMutCoord_v1(const TMutCoord* base_ptr) :
  TMutCoord(*base_ptr),
...
TMutCoord_v1::TMutCoord_v1(const TMutCoord& base_ref) :
  TMutCoord(base_ref),
...
void TMutCoord_v1::print(std::ostream& os) const {
...
PHLine TMutCoord_v1::get_coord() const
{
...
PHPoint TMutCoord_v1::get_coord_end() const
{
  // No BOUNDS_CHECK here because this
  // is not part of the public interface
  //
...
PHPoint TMutCoord_v1::get_coord_midpoint() const
{
  // No BOUNDS_CHECK here because this
  // is not part of the public interface
  //
...
PHPoint TMutCoord_v1::get_coord_begin() const
{
  // No BOUNDS_CHECK here because this
  // is not part of the public interface
  //
...
double TMutCoord_v1::get_mean_z() const
{
  return 0.5*(_point_1[2] + _point_2[2]);
}

void TMutCoord_v1::set_coord(const PHLine& line) 
{

...
#ifndef __TMUTMCTRK_V5H__
#define __TMUTMCTRK_V5H__
...
class TMutMCTrk_v5 : public TMutMCTrk
{
 ...
 public:
  ...
  TMutMCTrk_v5(const Key& key, UShort_t arm, UShort_t index);

  TMutMCTrk_v5(const TMutMCTrk*);  

  TMutMCTrk_v5(const TMutMCTrk&);

  virtual ~TMutMCTrk_v5(){;}

  ULong_t get_file_key() const {return _file_key;}

  Long_t get_track_id() const {return _track_id;}

  UShort_t get_pid() const {std::cout << "TMutMCTrk_v5::get_pid() WARNING - THIS METHOD IS DEPRECATED! USE get_pidG4()..." << std::endl; return 0;}
  ...
  Int_t get_grandparent_track_id() const { return _grandparent_track_id;}
  ...
  void set_grandparent_track_id(Int_t grandparent_track_id) {_grandparent_track_id = grandparent_track_id;}
  ...
  Int_t get_version() const {return 5;}
...
private:	
  ...
  Int_t _grandparent_track_id;
  
  ClassDef(TMutMCTrk_v5,1)
};
		
#endif /* __TMutMCTrk_v5H__*/

...
#ifndef __TMUTTRK_V1H__
#define __TMUTTRK_V1H__
...
class TMutTrk_v1 : public TMutTrk
{
 ...
 public:
  ...
  TMutTrk_v1(const Key&, 
	     UShort_t arm, 
	     UShort_t octant,
	     UShort_t index);

  TMutTrk_v1(const TMutTrk* base_ptr);
  TMutTrk_v1(const TMutTrk& base_ref);
  ...
  { 
    return 
      (get_global_fit() || get_kalman_fit() || get_bp_fit3()) 
...
private:	
  ...
  residual_list _w_residual_list;
  ...
  ClassDef(TMutTrk_v1,1)
};
  
#endif /* __TMUTTRK_V1H__*/

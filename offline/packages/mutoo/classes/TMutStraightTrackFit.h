#ifndef TMutStraightTrackFit_h
#define TMutStraightTrackFit_h
// $Id: TMutStraightTrackFit.h,v 1.1 2007/08/20 16:38:41 hpereira Exp $
...
class TMutStraightTrackFit
{
  
  public:
  
  //! constructor
  TMutStraightTrackFit( void ):

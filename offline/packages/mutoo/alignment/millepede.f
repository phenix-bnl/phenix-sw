* $Id: millepede.f,v 1.4 2015/09/09 01:50:17 jinhuang Exp $
...
*     Basic dimension parameters
      PARAMETER (MGLOBL=6000,MLOCAL=10,NSTORE=1000000,MCS=900) ! dimensions, increased for FVTX + MuTr alignment
...
*     ------------------------------------------------------------------
*     Basic dimension parameters
      PARAMETER (MGLOBL=6000,MLOCAL=10,NSTORE=1000000,MCS=900) ! dimensions, increased for FVTX + MuTr alignment ! dimensions
      PARAMETER (MGL=MGLOBL+MCS)                     ! derived parameter
*     derived parameters
      PARAMETER (MSYMGB  =(MGLOBL*MGLOBL+MGLOBL)/2,
     +           MSYM    =(MGL*MGL+MGL)/2,
...
*     ------------------------------------------------------------------
      ...
      SUBROUTINE INITUN(LUN, CUTFAC, FILENAME )

...
void fill_ntuple (PHCompositeNode *topNode); //++CINT
int setup_all(PHCompositeNode* dst_node); //++CINT
bool setup_display(); //++CINT
int end_all(); //++CINT
int dstout_fopen(PHString dstout_filename = "simdst.root",
	     PHString ndstout_filename = "simndst.root", 
	     char* ntout = "simntuple.root"); //++CINT;
//int dstout_fopen(PHString dstout_filename, char* outnt); //++CINT;

...
#ifndef __L2SingleTrackPC3LowOcupyMicroV1_H__
#define __L2SingleTrackPC3LowOcupyMicroV1_H__

#include <PHObject.h>

class L2SingleTrackPC3LowOcupyMicroV1 : public TObject 
{
 ...
 protected:
  ...
  float phi0;
  float charge;
  unsigned int regionPC3;
  unsigned int clustIDPC3;
  int CNTmatch;

  public:

    L2SingleTrackPC3LowOcupyMicroV1();
    ~L2SingleTrackPC3LowOcupyMicroV1(){}
     ...
     void    set_regionPC3(unsigned int input) {regionPC3=input;}
     void    set_clustIDPC3(unsigned int input) {clustIDPC3=input;}
     ...
     unsigned int get_regionPC3() {return regionPC3;}
     unsigned int get_clustIDPC3() {return clustIDPC3;}
     int      get_CNTmatch() {return CNTmatch;}


    ClassDef (L2SingleTrackPC3LowOcupyMicroV1, 1)
};
#endif	// __ L2SingleTrackPC3LowOcupyMicroV1_H__

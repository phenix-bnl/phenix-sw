#ifndef __CGLTRACKV6_H__
#define __CGLTRACKV6_H__
...
class CglTrackv6 : public CglTrack
{
 public:
  CglTrackv6();
  virtual ~CglTrackv6();
  ...
  short get_svxclusid(const unsigned int itrk, const short ilayer) const;
  void set_svxclusid(const unsigned int itrk, const short ilayer, const short ival);
 ...
 protected:
  ...
  ClassDef(CglTrackv6,1)
};

#endif /*__CGLTRACKV6_H__*/

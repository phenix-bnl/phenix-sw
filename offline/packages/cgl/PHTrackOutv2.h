#ifndef  __PHTRACKOUTV2_H
#define  __PHTRACKOUTV2_H
...
class PHTrackOutv2:public PHTrackOut
{
 public:
  PHTrackOutv2();
  virtual ~PHTrackOutv2();
  ...
  float get_projectionTzr(const unsigned int itrk, const short ival) const;
  void set_projectionTzr(const unsigned int itrk, const short ival, const float rval);
  
  float get_projectionPcr(const unsigned int itrk, const short ival) const;
  void set_projectionPcr(const unsigned int itrk, const short ival, const float rval);
  ...
  float get_directionTzr(const unsigned int itrk, const short ival) const;
  void set_directionTzr(const unsigned int itrk, const short ival, const float rval);
  
  float get_directionPcr(const unsigned int itrk, const short ival) const;
  void set_directionPcr(const unsigned int itrk, const short ival, const float rval);
  ...
  short ifIntersectTzr(const unsigned int itrk) const;
  short ifIntersectPcr(const unsigned int itrk) const;
  ...
  short get_ifIntersectTzr(const unsigned int itrk) const {return ifIntersectTof(itrk);}
  short get_ifIntersectPcr(const unsigned int itrk) const {return ifIntersectTof(itrk);}
  ...
  float get_tzrPathLength(const unsigned int itrk) const;
  void set_tzrPathLength(const unsigned int itrk, const float rval);
  
 protected:
  TClonesArray *GetPHTrk() const {return PHTrk;}
  unsigned int PHNTrack;
  TClonesArray *PHTrk;
  ClassDef(PHTrackOutv2,1)
};
#endif

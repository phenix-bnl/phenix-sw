#ifndef __CGLSNGLTRACKV4_H
#define __CGLSNGLTRACKV4_H

#include "CglSnglTrack.h"

class CglSnglTrackv4 : public CglSnglTrack
{
 public:
  CglSnglTrackv4();
  virtual ~CglSnglTrackv4() {}
 ...
 protected:
  ...
  ClassDef(CglSnglTrackv4,1)
};

#endif /* __CGLSNGLTRACKV4_H */

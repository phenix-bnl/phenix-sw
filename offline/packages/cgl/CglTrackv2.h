#ifndef __CGLTRACKV2_H__
#define __CGLTRACKV2_H__
...
class CglTrackv2 : public CglTrack
{
 public:
  CglTrackv2();
  virtual ~CglTrackv2();
  ...
  short get_tzrrecid(const unsigned int itrk) const;
  void set_tzrrecid(const unsigned int itrk, const short ival);

  short get_pcrrecid(const unsigned int itrk) const;
  void set_pcrrecid(const unsigned int itrk, const short ival);
 ...
 protected:
  ...
  ClassDef(CglTrackv2,1)
};

#endif /*__CGLTRACKV2_H__*/

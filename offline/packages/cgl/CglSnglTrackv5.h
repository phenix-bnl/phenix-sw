#ifndef __CGLSNGLTRACKV5_H
#define __CGLSNGLTRACKV5_H

#include "CglSnglTrack.h"

class CglSnglTrackv5 : public CglSnglTrack
{
 public:
  CglSnglTrackv5();
  virtual ~CglSnglTrackv5() {}
 ...
 protected:
  ...
  ClassDef(CglSnglTrackv5,1)
};

#endif /* __CGLSNGLTRACKV5_H */

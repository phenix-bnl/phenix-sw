#ifndef __CGLSNGLTRACKV3_H
#define __CGLSNGLTRACKV3_H

#include "PHObject.h"

class CglSnglTrackv3 : public TObject
{
 public:
  CglSnglTrackv3();
  virtual ~CglSnglTrackv3() {}
 ...
 protected:
  ...
  ClassDef(CglSnglTrackv3,1)
};

#endif /* __CGLSNGLTRACKV3_H */

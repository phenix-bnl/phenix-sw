#ifndef  __PHTRACKOUTV6_H
#define  __PHTRACKOUTV6_H
...
class PHTrackOutv6:public PHTrackOut
{
 public:
  PHTrackOutv6();
  virtual ~PHTrackOutv6();
  ...
  float get_projectionSvx(const unsigned int itrk, const short ilayer, const short ival) const;
  void set_projectionSvx(const unsigned int itrk, const short ilayer, const short ival, const float rval);
  ...
  float get_projectionMrpc(const unsigned int itrk, const short ival) const;
  void set_projectionMrpc(const unsigned int itrk, const short ival, const float rval);
  ...
  float get_directionSvx(const unsigned int itrk, const short ilayer, const short ival) const;
  void set_directionSvx(const unsigned int itrk, const short ilayer, const short ival, const float rval);
  ...
  float get_directionMrpc(const unsigned int itrk, const short ival) const;
  void set_directionMrpc(const unsigned int itrk, const short ival, const float rval);
  ...
  short ifIntersectSvx(const unsigned int itrk, const short ilayer) const;
  ...
  short ifIntersectMrpc(const unsigned int itrk) const;
  ...
  short get_ifIntersectSvx(const unsigned int itrk, const short ilayer) const {return ifIntersectSvx(itrk, ilayer);}
  ...
  float get_mrpcPathLength(const unsigned int itrk) const;
  void set_mrpcPathLength(const unsigned int itrk, const float rval);
  
 protected:
  TClonesArray *GetPHTrk() const {return PHTrk;}
  unsigned int PHNTrack;
  TClonesArray *PHTrk;
  ClassDef(PHTrackOutv6,1)
};
#endif

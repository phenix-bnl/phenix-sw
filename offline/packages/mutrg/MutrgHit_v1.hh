#ifndef __MUTRGHIT_V1__
#define __MUTRGHIT_V1__

#include "MutrgPar.hh"
#include "MutrgHit.hh"

class MutrgHit_v1 : public MutrgHit{
public:
  MutrgHit_v1();
  virtual ~MutrgHit_v1(){;}
  MutrgHit* Create(void){return new MutrgHit_v1();}
  void Reset(void);
  void Clear(Option_t* ="");
...
protected:
  ...
  float charge[MutrgPar::MAX_NGAP]; // MAX_NGAP=3
  float charge_error[MutrgPar::MAX_NGAP]; // MAX_NGAP=3
  float peak_time[MutrgPar::MAX_NGAP]; // MAX_NGAP=3

  ClassDef(MutrgHit_v1,1)
};

#endif /* __MUTRGHIT_V1__ */

#ifndef __MUTRGHIT_V3__
#define __MUTRGHIT_V3__

#include "MutrgPar.hh"
#include "MutrgHit.hh"

class MutrgHit_v3 : public MutrgHit{
public:
  MutrgHit_v3();
  virtual ~MutrgHit_v3(){;}
  MutrgHit* Create(void){return new MutrgHit_v3();}
  void Reset(void);
  void Clear(Option_t* ="");
  ...
  void SetMutMaxCharge(float q){charge_max=q;}
  ...
  float GetMutMaxCharge(void) const{return charge_max;}
...
protected:
  ...
  float charge_max; // maximum charge in planes MuTRG is installed

  ClassDef(MutrgHit_v3,1)
};

#endif /* __MUTRGHIT_V3__ */

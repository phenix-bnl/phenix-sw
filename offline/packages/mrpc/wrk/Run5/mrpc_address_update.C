void mrpc_address_update()
{
  // __________________________________________________________
  //
  //  This macro does the DB update for MRPC address.
  //  
  ...
  //Update
  address->fetch("./addresspar/mrpc_address_Run5.txt");
  address->print(10);
  address->update(146651);
  address->write("./addresspar/out/mrpc_address_out.txt");

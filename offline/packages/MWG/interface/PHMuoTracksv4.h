#ifndef __PHMUOTRACKSV4_H
#define __PHMUOTRACKSV4_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHMuoTracksv4 : public PHMuoTracksOut
{

public:
  PHMuoTracksv4();
  PHMuoTracksv4(TClonesArray* MuT);
  virtual ~PHMuoTracksv4();
  
  //========== Standard functions of all virtual classes...
  void Reset(){nMuoTracks = 0; Clear();}
  void identify(std::ostream &os=std::cout) const {
      os << "identify yourself:  PHMuoTracksv4 object" << std::endl;
      return;
  }

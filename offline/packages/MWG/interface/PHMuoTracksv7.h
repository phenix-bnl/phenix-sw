#ifndef __PHMUOTRACKSV7_H
#define __PHMUOTRACKSV7_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHMuoTracksv7 : public PHMuoTracksOut
{

public:
  PHMuoTracksv7();
  PHMuoTracksv7(TClonesArray* MuT);
  virtual ~PHMuoTracksv7();
  
  //========== Standard functions of all virtual classes...
  void Reset(){nMuoTracks = 0; Clear();}
  void identify(std::ostream &os=std::cout) const {
      os << "identify yourself:  PHMuoTracksv7 object" << std::endl;
      return;
  }
  ...
  void AddPHParticle(const unsigned int itrk){
      new ((*MuoTracks)[itrk]) PHMuoTrackv7();
  }

#ifndef __PHMuoTracksv11_H
#define __PHMuoTracksv11_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHMuoTracksv11 : public PHMuoTracksOut
{
  ...
  //! constructor
  PHMuoTracksv11(TClonesArray* MuT);
  
  //! destructor
  virtual ~PHMuoTracksv11();
  ...
  {
      os << "identify yourself:  PHMuoTracksv11 object" << std::endl;
      return;
  }

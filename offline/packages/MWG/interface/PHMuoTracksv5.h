#ifndef __PHMUOTRACKSV5_H
#define __PHMUOTRACKSV5_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHMuoTracksv5 : public PHMuoTracksOut
{

public:
  PHMuoTracksv5();
  PHMuoTracksv5(TClonesArray* MuT);
  virtual ~PHMuoTracksv5();
  
  //========== Standard functions of all virtual classes...
  void Reset(){nMuoTracks = 0; Clear();}
  void identify(std::ostream &os=std::cout) const {
      os << "identify yourself:  PHMuoTracksv5 object" << std::endl;
      return;
  }

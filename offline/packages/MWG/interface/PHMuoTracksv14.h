#ifndef __PHMuoTracksv14_H
#define __PHMuoTracksv14_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHMuoTracksv14 : public PHMuoTracksOut
{
  ...
  //! constructor
  PHMuoTracksv14(TClonesArray* MuT);
  
  //! destructor
  virtual ~PHMuoTracksv14();
  ...
  {
      os << "identify yourself:  PHMuoTracksv14 object" << std::endl;
      return;
  }
  ...
  {
      new ((*MuoTracks)[itrk]) PHMuoTrackv14();
  }
  ...
  virtual PHMuoTracksv14* clone() const;
  ...
  //! return number of clusters with size==1
  short get_nclusters_size1(const unsigned int itrk) const;
  ...
  size_t get_nfvtx_tracklets_conerange(const unsigned int itrk, size_t dR_bin) const;
  ...
  void set_nclusters_size1(const unsigned int itrk, const short n);

#ifndef __PHMuoTracksv9_H
#define __PHMuoTracksv9_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHMuoTracksv9 : public PHMuoTracksOut
{
  ...
  //! constructor
  PHMuoTracksv9(TClonesArray* MuT);
  
  //! destructor
  virtual ~PHMuoTracksv9();
  ...
  {
      os << "identify yourself:  PHMuoTracksv9 object" << std::endl;
      return;
  }
  ...
  {
      new ((*MuoTracks)[itrk]) PHMuoTrackv9();
  }

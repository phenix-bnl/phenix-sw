#ifndef __PHMuoTracksv15_H
#define __PHMuoTracksv15_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHMuoTracksv15 : public PHMuoTracksOut
{
  ...
  //! constructor
  PHMuoTracksv15(TClonesArray* MuT);
  
  //! destructor
  virtual ~PHMuoTracksv15();
  ...
  {
      os << "identify yourself:  PHMuoTracksv15 object" << std::endl;
      return;
  }
  ...
  {
      new ((*MuoTracks)[itrk]) PHMuoTrackv15();
  }
  ...
  virtual PHMuoTracksv15* clone() const;

#ifndef __PHDIMUOTRACKV4_H
#define __PHDIMUOTRACKV4_H
#include "PHObject.h"
...
*/
class PHdiMuoTrackv4 : public TObject
{
 public:
    ...
    */
    ...
    void set_vtx_bp_xpos(float newVal) {vtx_bp_xpos = newVal;}
    void set_vtx_bp_ypos(float newVal) {vtx_bp_ypos = newVal;}
    void set_vtx_bp_zpos(float newVal) {vtx_bp_zpos = newVal;}
    void set_vtx_bp_dca(float newVal)  {vtx_bp_dca = newVal;}
    ...
    void set_vtx_ndf(int newVal)    {vtx_ndf=newVal;}

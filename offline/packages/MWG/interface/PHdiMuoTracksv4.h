#ifndef __PHDIMUOTRACKSV4_H
#define __PHDIMUOTRACKSV4_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHdiMuoTracksv4 : public PHMuoTracksOut
{
typedef PHMuoTracksv4 MuTr;

public:
  PHdiMuoTracksv4();
  virtual ~PHdiMuoTracksv4();
  ...
  void AddPHDimuon(const unsigned int idimu){
      new ((*diMuoTracks)[idimu]) PHdiMuoTrackv3();
  }
  ...
  */
  ...
  /// Return {\bf idimu}$^{th}$ chisquare from vertex fit.
  ...
  { new ((*MuoTracks)[itrk]) PHMuoTrackv4(); }
  ...
  float get_muID_gap0(short arrayid, const unsigned int itrk) const;
  ...
  void set_muID_gap0(short arrayid, const unsigned int itrk, float newVal);

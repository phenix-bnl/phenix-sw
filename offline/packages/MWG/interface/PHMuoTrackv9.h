#ifndef __PHMuoTrackv9_H
#define __PHMuoTrackv9_H
#include "PHObject.h"
#include "phool.h"
...
*/
class PHMuoTrackv9 : public TObject
{
 public:
  ...
  */
  ...
  { 
    ...
    {
      std::cout<<PHWHERE<<" PHMuoTrackv9::get_delta_q id out of range.\n";
      return 0;
    }    
  ...
  { 
    if( coord_id >= _max_gap_coords ) 
    {
      std::cout<<PHWHERE<<" PHMuoTrackv9::get_delta_q_error id out of range.\n";
      return 0;
    }    
  ...
  { 
    if( coord_id >= _max_gap_coords ) 
    {
      std::cout<<PHWHERE<<" PHMuoTrackv9::set_delta_q id out of range.\n";
      return;
    }    
  ...
  { 
    if( coord_id >= _max_gap_coords ) 
    {
      std::cout<<PHWHERE<<" PHMuoTrackv9::set_delta_q_error id out of range.\n";
      return;
    }    
  ...
  float muID_proj_hit_dist[5][2][_max_mui_hits]; // 5 gaps; 2 orientations (h/v); 10 closest hits

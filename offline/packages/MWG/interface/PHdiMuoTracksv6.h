#ifndef __PHDIMUOTRACKSV6_H
#define __PHDIMUOTRACKSV6_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHdiMuoTracksv6 : public PHMuoTracksOut
{

public:
  PHdiMuoTracksv6();
  virtual ~PHdiMuoTracksv6();

  //========== Standard functions of all virtual classes...
  void Reset(){nMuoTracks = 0; ndiMuoTracks = 0; Clear();}
  void identify(std::ostream &os=std::cout) const {
      os << "identify yourself:  PHdiMuoTracksv6 object" << std::endl;
      return;
  }

#ifndef __PHMUOTRACKSV2_H
#define __PHMUOTRACKSV2_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHMuoTracksv2 : public PHMuoTracksOut
{

public:
  PHMuoTracksv2();
  PHMuoTracksv2(TClonesArray* MuT);
  virtual ~PHMuoTracksv2();
  
  //========== Standard functions of all virtual classes...
  void Reset(){nMuoTracks = 0; Clear();}
  void identify(std::ostream &os=std::cout) const {
      os << "identify yourself:  PHMuoTracksv2 object" << std::endl;
      return;
  }
  ...
  */
  ...
  /// Return {\bf itrk}$^{th}$ track {\bf hitplans}.

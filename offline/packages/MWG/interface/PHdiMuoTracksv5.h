#ifndef __PHDIMUOTRACKSV5_H
#define __PHDIMUOTRACKSV5_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHdiMuoTracksv5 : public PHMuoTracksOut
{
typedef PHMuoTracksv5 MuTr;

public:
  PHdiMuoTracksv5();
  virtual ~PHdiMuoTracksv5();
  ...
  */
  ...
  { new ((*MuoTracks)[itrk]) PHMuoTrackv5(); }

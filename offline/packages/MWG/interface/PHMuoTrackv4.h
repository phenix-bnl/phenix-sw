#ifndef __PHMUOTRACKV4_H
#define __PHMUOTRACKV4_H
#include "PHObject.h"
...
*/
class PHMuoTrackv4 : public TObject
{
 public:
    ...
    */
    ...
    float get_muID_gap0(short arrayid) const;
    ...
    void set_muID_gap0(short arrayid, float newVal);

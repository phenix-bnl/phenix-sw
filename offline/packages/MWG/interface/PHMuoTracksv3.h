#ifndef __PHMUOTRACKSV3_H
#define __PHMUOTRACKSV3_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHMuoTracksv3 : public PHMuoTracksOut
{

public:
  PHMuoTracksv3();
  PHMuoTracksv3(TClonesArray* MuT);
  virtual ~PHMuoTracksv3();
  
  //========== Standard functions of all virtual classes...
  void Reset(){nMuoTracks = 0; Clear();}
  void identify(std::ostream &os=std::cout) const {
      os << "identify yourself:  PHMuoTracksv3 object" << std::endl;
      return;
  }
  ...
  void AddPHParticle(const unsigned int itrk){
      new ((*MuoTracks)[itrk]) PHMuoTrackv3();
  }

#ifndef __PHDIMUOTRACKSV3_H
#define __PHDIMUOTRACKSV3_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHdiMuoTracksv3 : public PHMuoTracksOut
{
typedef PHMuoTracksv3 MuTr;
...
public:
  ...
  */
  ...
  //===================================== Dimuon Mutators
  void set_ndimu(unsigned int ndimu) { ndiMuoTracks = ndimu; }

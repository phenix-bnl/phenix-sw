#ifndef __PHDIMUOTRACKSv9_H
#define __PHDIMUOTRACKSv9_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHdiMuoTracksv9 : public PHMuoTracksOut
{
  ...
  {
      os << "identify yourself:  PHdiMuoTracksv9 object" << std::endl;
      return;
  }

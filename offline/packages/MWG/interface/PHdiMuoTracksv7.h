#ifndef __PHDIMUOTRACKSV7_H
#define __PHDIMUOTRACKSV7_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHdiMuoTracksv7 : public PHMuoTracksOut
{

public:
  PHdiMuoTracksv7();
  virtual ~PHdiMuoTracksv7();

  //========== Standard functions of all virtual classes...
  void Reset(){nMuoTracks = 0; ndiMuoTracks = 0; Clear();}
  void identify(std::ostream &os=std::cout) const {
      os << "identify yourself:  PHdiMuoTracksv7 object" << std::endl;
      return;
  }

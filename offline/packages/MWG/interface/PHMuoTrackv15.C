...
ClassImp(PHMuoTrackv15)

//________________________________________________________________
PHMuoTrackv15::PHMuoTrackv15():
uid(0),
  charge(0), 
  ndf( 0 ),
  chisquare( 0 ),
...
//________________________________________________________________
void PHMuoTrackv15::identify(std::ostream & out) const
{
  out << "identify yourself: I am a mutr track object" << std::endl;
}

//===== accessors
float PHMuoTrackv15::get_px(short arrayid) const
{ return (0<=arrayid && arrayid<_maxpoints) ? px[arrayid] : 0; }

float PHMuoTrackv15::get_py(short arrayid) const
{ return (0<=arrayid && arrayid<_maxpoints) ? py[arrayid] : 0; }

float PHMuoTrackv15::get_pz(short arrayid) const
{ return (0<=arrayid && arrayid<_maxpoints) ? pz[arrayid] : 0; }

float PHMuoTrackv15::get_st1_bp_P(short arrayid) const
{ return (0<=arrayid && arrayid<3) ? st1_bp_P[arrayid] : 0; }

float PHMuoTrackv15::get_st1_bp_pos(short arrayid) const
{ return (0<=arrayid && arrayid<3) ? st1_bp_pos[arrayid] : 0; }

//_____________________________________________________
float PHMuoTrackv15::get_xpos(short arrayid) const
{ return (0<=arrayid && arrayid<_maxpoints) ? xpos[arrayid] : 0; }

//_____________________________________________________
float PHMuoTrackv15::get_ypos(short arrayid) const
{ return (0<=arrayid && arrayid<_maxpoints) ? ypos[arrayid] : 0; }

//_____________________________________________________
float PHMuoTrackv15::get_zpos(short arrayid) const
{ return (0<=arrayid && arrayid<_maxpoints) ? zpos[arrayid] : 0; }

//_____________________________________________________
float PHMuoTrackv15::get_cov(short arrayid1, short arrayid2) const
{ 
  return 
...
//_____________________________________________________
float PHMuoTrackv15::get_muIDOO_gap0(const short arrayid, const short iroad) const
{ return ((0<=arrayid && arrayid<5)&&(0<=iroad && iroad < _maxroads)) ? muIDOO_gap0[arrayid][iroad] : 0; }

//_____________________________________________________
float PHMuoTrackv15::get_muid_hit_x(short gap) const
{ return (0<=gap && gap<5) ? _muid_hit_x[gap] : -8888; }

//_____________________________________________________
float PHMuoTrackv15::get_muid_hit_y(short gap) const
{ return (0<=gap && gap<5) ? _muid_hit_y[gap] : -8888; }

//================================ Mutators ===================================
void PHMuoTrackv15::set_px(short arrayid, float newVal)
{
  if (arrayid<0 || arrayid>=_maxpoints)
    {
      std::cout<<PHWHERE<<" PHMuoTrackv15::set_px id out of range.\n";
      exit(1);
    }
  px[arrayid] = newVal;
}
void PHMuoTrackv15::set_py(short arrayid, float newVal)
{
  if (arrayid<0 || arrayid>=_maxpoints)
    {
      std::cout<<PHWHERE<<" PHMuoTrackv15::set_py id out of range.\n";
      exit(1);
    }
  py[arrayid] = newVal;
}
void PHMuoTrackv15::set_pz(short arrayid, float newVal)
{
  if (arrayid<0 || arrayid>=_maxpoints)
    {
      std::cout<<PHWHERE<<" PHMuoTrackv15::set_pz id out of range.\n";
      exit(1);
    }
  pz[arrayid] = newVal;
}
void PHMuoTrackv15::set_st1_bp_P(short arrayid, float newVal)
{
...
void PHMuoTrackv15::set_st1_bp_pos(short arrayid, float newVal)
{
  if (arrayid<0 || arrayid>=3) 
    {
...
void PHMuoTrackv15::set_xpos(short arrayid, float newVal)
{
  if (arrayid<0 || arrayid>=_maxpoints)
    {
      std::cout<<PHWHERE<<" PHMuoTrackv15::set_xpos id out of range.\n";
      exit(1);
    }
  xpos[arrayid] = newVal;
}
void PHMuoTrackv15::set_ypos(short arrayid, float newVal)
{
  if (arrayid<0 || arrayid>=_maxpoints)
    {
      std::cout<<PHWHERE<<" PHMuoTrackv15::set_ypos id out of range.\n";
      exit(1);
    }
  ypos[arrayid] = newVal;
}
void PHMuoTrackv15::set_zpos(short arrayid, float newVal)
{
  if (arrayid<0 || arrayid>=_maxpoints)
    {
      std::cout<<PHWHERE<<" PHMuoTrackv15::set_zpos id out of range.\n";
      exit(1);
    }
  zpos[arrayid] = newVal;
}
void PHMuoTrackv15::set_cov(short arrayid1, short arrayid2, float newVal)
{
  if(arrayid1<0 || arrayid1 >= _covdim || 
     arrayid2<0 || arrayid2 >= _covdim)
    {
      std::cout<<PHWHERE<<" PHMuoTrackv15::set_cov id out of range. \n";
      exit(1);
    }
  cov[arrayid1][arrayid2] = newVal;
}

void PHMuoTrackv15::set_muIDOO_gap0(const short arrayid, const short iroad, float newVal)
{
  if (arrayid<0 || arrayid>=5 || iroad < 0 || iroad >= _maxroads ) {
    std::cout<<PHWHERE<<" PHMuoTrackv15::set_muID_gap0 id out of range.\n";
    return ;
  }
...
//
void PHMuoTrackv15::set_muid_hit_x(short gap, float newVal)
{
  if(0>gap && gap>=5) {
    std::cout << PHWHERE << " PHMuoTrackv15::set_muid_hit_x gap out of range.\n";
    return ;
  }
  _muid_hit_x[gap] = newVal;
}

void PHMuoTrackv15::set_muid_hit_y(short gap, float newVal)
{
  if(0>gap && gap>=5) {
    std::cout << PHWHERE << " PHMuoTrackv15::set_muid_hit_y gap out of range.\n";
    return ;
  }
  _muid_hit_y[gap] = newVal;
}

void PHMuoTrackv15::set_nfvtx_tracklets_conerange(size_t dRbin, size_t ntracklets)
{
...
size_t PHMuoTrackv15::get_nfvtx_tracklets_conerange(size_t dRbin) const
{
  if (dRbin>=8) return 0;
...
void PHMuoTrackv15::set_nfvtx_clusters_conerange(size_t dRbin, size_t nclusters)
{
  if (dRbin>=8) return; // out of range
...
size_t PHMuoTrackv15::get_nfvtx_clusters_conerange(size_t dRbin) const
{
  if (dRbin>=8) return 0;

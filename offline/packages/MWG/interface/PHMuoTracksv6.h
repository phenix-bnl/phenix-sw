#ifndef __PHMUOTRACKSV6_H
#define __PHMUOTRACKSV6_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHMuoTracksv6 : public PHMuoTracksOut
{

public:
  PHMuoTracksv6();
  PHMuoTracksv6(TClonesArray* MuT);
  virtual ~PHMuoTracksv6();
  
  //========== Standard functions of all virtual classes...
  void Reset(){nMuoTracks = 0; Clear();}
  void identify(std::ostream &os=std::cout) const {
      os << "identify yourself:  PHMuoTracksv6 object" << std::endl;
      return;
  }
  ...
  void AddPHParticle(const unsigned int itrk){
      new ((*MuoTracks)[itrk]) PHMuoTrackv6();
  }

#ifndef __PHMuoTracksv13_H
#define __PHMuoTracksv13_H
#include <iostream>
#include "PHObject.h"
...
*/
class PHMuoTracksv13 : public PHMuoTracksOut
{
  ...
  //! constructor
  PHMuoTracksv13(TClonesArray* MuT);
  
  //! destructor
  virtual ~PHMuoTracksv13();
  ...
  {
      os << "identify yourself:  PHMuoTracksv13 object" << std::endl;
      return;
  }
  ...
  {
      new ((*MuoTracks)[itrk]) PHMuoTrackv13();
  }
  ...
  virtual PHMuoTracksv13* clone() const;

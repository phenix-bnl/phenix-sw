#ifndef __PHMUOTRACKV2_H
#define __PHMUOTRACKV2_H
#include "PHObject.h"
...
*/
class PHMuoTrackv2 : public TObject
{
 public:
    ...
    */
    ...
    // Return {\bf hitplans}.
    int get_hitplans() const {return hitplans;}
    //@}
    ...
    void set_hitplans(int newVal){ hitplans = newVal;}

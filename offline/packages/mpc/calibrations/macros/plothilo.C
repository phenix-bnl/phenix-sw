...
Double_t hilolimitmean[2][18][18];
Double_t hilolimitrms[2][18][18];
Int_t    hilolimitstatus[2][18][18];

Double_t hiloratiomean[2][18][18];
Double_t hiloratiorms[2][18][18];
Int_t    hiloratiostatus[2][18][18];
      ...
      for (int ix=0; ix<18; ix++)
        {
          for (int iy=0; iy<18; iy++)
            {
              hilolimitmean[iarm][ix][iy] = -1.0;
              hilolimitrms[iarm][ix][iy] = -1.0;
              hilolimitstatus[iarm][ix][iy] = -1;
            }
        }
    }
...
*/
  ...
  // Draw on Canvas
  TCanvas *chilolimit[2];
  chilolimit[0] = new TCanvas("chilolimit0","hilolimit arm 0",1000,1000);
  chilolimit[0]->Divide(18,18,0.0001,0.0001);
  chilolimit[1] = new TCanvas("chilolimit1","hilolimit arm 1",1000,1000);
  chilolimit[1]->Divide(18,18,0.0001,0.0001);

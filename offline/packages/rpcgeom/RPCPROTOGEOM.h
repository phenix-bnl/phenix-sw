#ifndef _RPCPROTOGEOM_h_
#define _RPCPROTOGEOM_h_

/*!
	\file RPCPROTOGEOM.h
	\brief description of the prototype "D" geometry
...
class RPCPROTOGEOM : public TObject
{
 public:
  ...
  //constructor
  RPCPROTOGEOM();
  RPCPROTOGEOM(RPCPROTOGEOM::ArmNumber fArm,
  ...
  virtual ~RPCPROTOGEOM(){}
	...
	PHPoint getStartPosition(RPCPROTOGEOM::ArmNumber fArm,
				 RPCPROTOGEOM::StationNumber fStation,
				 Int_t fOctant, Int_t fHalfOctant,
				 RPCPROTOGEOM::RadialSegment fRadSeg,
				 Int_t fChannel);
	double getStartPositionX(RPCPROTOGEOM::ArmNumber fArm,
				 RPCPROTOGEOM::StationNumber fStation,
				 Int_t fOctant, Int_t fHalfOctant,
				 RPCPROTOGEOM::RadialSegment fRadSeg,
				 Int_t fChannel);
	double getStartPositionY(RPCPROTOGEOM::ArmNumber fArm,
				 RPCPROTOGEOM::StationNumber fStation,
				 Int_t fOctant, Int_t fHalfOctant,
				 RPCPROTOGEOM::RadialSegment fRadSeg,
				 Int_t fChannel);
	double getStartPositionZ(RPCPROTOGEOM::ArmNumber fArm,
				 RPCPROTOGEOM::StationNumber fStation,
				 RPCPROTOGEOM::RadialSegment fRadSeg);
	PHPoint getEndPosition(RPCPROTOGEOM::ArmNumber fArm,
			       RPCPROTOGEOM::StationNumber fStation,
			       Int_t fOctant, Int_t fHalfOctant,
			       RPCPROTOGEOM::RadialSegment fRadSeg,
			       Int_t fChannel);
	double getEndPositionX(RPCPROTOGEOM::ArmNumber fArm,
			       RPCPROTOGEOM::StationNumber fStation,
			       Int_t fOctant, Int_t fHalfOctant,
			       RPCPROTOGEOM::RadialSegment fRadSeg,
			       Int_t fChannel);
	double getEndPositionY(RPCPROTOGEOM::ArmNumber fArm,
			       RPCPROTOGEOM::StationNumber fStation,
			       Int_t fOctant, Int_t fHalfOctant,
			       RPCPROTOGEOM::RadialSegment fRadSeg,
			       Int_t fChannel);
	double getEndPositionZ(RPCPROTOGEOM::ArmNumber fArm,
			       RPCPROTOGEOM::StationNumber fStation,
			       RPCPROTOGEOM::RadialSegment fRadSeg);
	
	RPCPROTOGEOM::ArmNumber fThisArm;
	RPCPROTOGEOM::StationNumber fThisStation;
	Int_t fThisOctant;
	Int_t fThisHalfOctant;
	RPCPROTOGEOM::RadialSegment fThisRadSeg;
	Int_t fThisChannel;

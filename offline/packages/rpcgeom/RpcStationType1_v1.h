// $Id: RpcStationType1_v1.h,v 1.3 2005/09/15 18:57:59 hpereira Exp $

#ifndef _RpcStationType1_v1_h_
#define _RpcStationType1_v1_h_

/*!
	\file RpcStationType1_v1.h
...
/*!	
	...
	Type1 station is circular. Geometry implemented using r, phi segmentation and r window.
*/
class RpcStationType1_v1: public RpcStationType1
{
	public: 
			
	//! constructor 
	RpcStationType1_v1( UShort_t arm = 0, UShort_t index = 0 ):
			_arm( arm ),
			_index( index ),
			_z( 0 ),
			_phi_segmentation( 0 ),
	...
	//! destructor
	virtual	~RpcStationType1_v1(void)
	{ clear_pads(); }
	...
	*/
	...
	{
		out << "RpcStationType1_v1::print - index: " << _index << " z: " << _z << std::endl;

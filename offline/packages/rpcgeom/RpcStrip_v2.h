...
#ifndef __RpcStrip_v2_H__
#define __RpcStrip_v2_H__
...
class RpcStrip_v2 : public RpcStrip
{
 ...
 public: 
  ...
  virtual int GetNumStrips(int _arm,int _station,int _octant,int _halfoctant,int _Rseg) { std::cout << "Depreciated Function \"GetNumStrips\" for RpcStrip_v2" << std::endl; return -999;}
  
  // Init
  virtual const void Init(){InitVal();}

  virtual void print(std::ostream& os = std::cout) const{
    os << "RpcStrip_v2::print " << std::endl
       << "arm " << arm << "\tsta " << station

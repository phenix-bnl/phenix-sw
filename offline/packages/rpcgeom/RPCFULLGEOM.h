#ifndef _RPCFULLGEOM_h_
#define _RPCFULLGEOM_h_
...
class RPCFULLGEOM : public TObject
{
 public:
  ...
  //constructor
  RPCFULLGEOM();
  RPCFULLGEOM(RPCFULLGEOM::ArmNumber fArm,
  ...
  virtual ~RPCFULLGEOM(){}
	...
	PHPoint getStartPosition(RPCFULLGEOM::ArmNumber fArm,
				 RPCFULLGEOM::StationNumber fStation,
				 Int_t fOctant, Int_t fHalfOctant,
				 RPCFULLGEOM::RadialSegment fRadSeg,
				 Int_t fChannel);
	double getStartPositionX(RPCFULLGEOM::ArmNumber fArm,
				 RPCFULLGEOM::StationNumber fStation,
				 Int_t fOctant, Int_t fHalfOctant,
				 RPCFULLGEOM::RadialSegment fRadSeg,
				 Int_t fChannel);
	double getStartPositionY(RPCFULLGEOM::ArmNumber fArm,
				 RPCFULLGEOM::StationNumber fStation,
				 Int_t fOctant, Int_t fHalfOctant,
				 RPCFULLGEOM::RadialSegment fRadSeg,
				 Int_t fChannel);
	double getStartPositionZ(RPCFULLGEOM::ArmNumber fArm,
				 RPCFULLGEOM::StationNumber fStation,
				 RPCFULLGEOM::RadialSegment fRadSeg);
	PHPoint getEndPosition(RPCFULLGEOM::ArmNumber fArm,
			       RPCFULLGEOM::StationNumber fStation,
			       Int_t fOctant, Int_t fHalfOctant,
			       RPCFULLGEOM::RadialSegment fRadSeg,
			       Int_t fChannel);
	double getEndPositionX(RPCFULLGEOM::ArmNumber fArm,
			       RPCFULLGEOM::StationNumber fStation,
			       Int_t fOctant, Int_t fHalfOctant,
			       RPCFULLGEOM::RadialSegment fRadSeg,
			       Int_t fChannel);
	double getEndPositionY(RPCFULLGEOM::ArmNumber fArm,
			       RPCFULLGEOM::StationNumber fStation,
			       Int_t fOctant, Int_t fHalfOctant,
			       RPCFULLGEOM::RadialSegment fRadSeg,
			       Int_t fChannel);
	double getEndPositionZ(RPCFULLGEOM::ArmNumber fArm,
			       RPCFULLGEOM::StationNumber fStation,
			       RPCFULLGEOM::RadialSegment fRadSeg);
	
	RPCFULLGEOM::ArmNumber fThisArm;
	RPCFULLGEOM::StationNumber fThisStation;
	Int_t fThisOctant;
	Int_t fThisHalfOctant;
	RPCFULLGEOM::RadialSegment fThisRadSeg;
	Int_t fThisChannel;

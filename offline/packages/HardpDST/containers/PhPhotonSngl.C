...
ClassImp(PhPhotonSngl)

  using namespace std;

//_____________________________________________________________________________
PhPhotonSngl::PhPhotonSngl() :
  fTowerid(0),
  fPartesum(0)
{
  Reset();
...
//_____________________________________________________________________________
PhPhotonSngl::PhPhotonSngl(const PhPhotonSngl& to)
  : fTowerid(0),
    fPartesum(0)
{
  to.copy(*this);
...
//_____________________________________________________________________________
PhPhotonSngl&
PhPhotonSngl::operator=(const PhPhotonSngl& to)
{
  if ( this != &to ) 
    {
      Reset();
...
//_____________________________________________________________________________
PhPhotonSngl*
PhPhotonSngl::clone(void) const
{
  return new PhPhotonSngl(*this);
}

//_____________________________________________________________________________
PhPhotonSngl*
PhPhotonSngl::create(void) const
{
  return new PhPhotonSngl;
}
...
//_____________________________________________________________________________
void PhPhotonSngl::Clear(Option_t*)
{
  delete[] fPartesum;
  fPartesum=0;
  delete[] fTowerid;
...
//_____________________________________________________________________________
void
PhPhotonSngl::copy(PhPhotonSngl& to) const
{
...
//_____________________________________________________________________________
void
PhPhotonSngl::identify(std::ostream& os) const
{
  os << "PhPhotonSngl:" << endl;
  os << "Id : " << id() 
     << ", Arm : " << arm()
     << ", Sector : " << sector() << endl;
  os << "X : " << x() 
...
//_____________________________________________________________________________
float
PhPhotonSngl::partesum(int index) const
{
  if (index>=0 && index<fMultiplicity)
    ...
    {
      cerr << "PhPhotonSngl::partesum : index out of bounds ("
...
//_____________________________________________________________________________
void
PhPhotonSngl::print(std::ostream& out) const
{ 
...
//_____________________________________________________________________________
int
PhPhotonSngl::towerid(int index) const
{
  if (index>=0 && index<fMultiplicity)
    {
    ...
    {
      cerr << "PhPhotonSngl::towerid : index out of bounds ("
	   << index << " out of " << fMultiplicity << ")" << endl;
      return 0;
    }
}
...
//_____________________________________________________________________________
void
PhPhotonSngl::set_multiplicity(int mul)
{
  fMultiplicity=mul;
...
//_____________________________________________________________________________
void
PhPhotonSngl::set_partesum(int index, float value)
{
  if ( !fPartesum ) 
    {
      cerr << "PhPhotonSngl::set_partesum : internal array is null."
  ...
  if (index>=0 && index<fMultiplicity)
    ...
    {
      cerr << "PhPhotonSngl::set_partesum : index out of bounds ("
	   << index << " out of " << fMultiplicity << ")" << endl;
    }
}
...
//_____________________________________________________________________________
void
PhPhotonSngl::set_towerid(int index, int value)
{ 
  if ( !fTowerid ) 
    {
      cerr << "PhPhotonSngl::set_towerid : internal array is null."
	   << " Did you forgot to specify the multiplicity ?"
	   << endl;
      return;
    }
  ...
  if (index>=0 && index<fMultiplicity)
    ...
    {
      cerr << "PhPhotonSngl::set_towerid : index out of bounds ("
	   << index << " out of " << fMultiplicity << ")" << endl;
    }
}

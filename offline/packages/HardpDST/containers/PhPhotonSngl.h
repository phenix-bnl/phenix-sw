#ifndef _PhPhotonSngl_h_
#define _PhPhotonSngl_h_

#include "emcClusterContent.h"

class PhPhotonSngl : public emcClusterContent{
  
 public:
  PhPhotonSngl();
  PhPhotonSngl(const PhPhotonSngl&);
  PhPhotonSngl& operator=(const PhPhotonSngl&);

  PhPhotonSngl* clone(void) const;
  PhPhotonSngl* create(void) const;

  virtual ~PhPhotonSngl();
...
private:
  ...
  void copy(PhPhotonSngl& to) const;

// ==================
// FILE: SvxCentralTrackv7.h
// ==================

#ifndef __SVXCENTRALTRACKV7_H_
#define __SVXCENTRALTRACKV7_H_
...
/**
 * @brief  The implementation v7 of SvxCentralTrack.
 *
 * Bumped from v6 on 06/18/2013 by Andrew Adare.
 * Added m_live_percentage and accessors.
 */


class SvxCentralTrackv7 : public SvxCentralTrack
{
 public:
 ...
 public:
  ...
  virtual void identify(std::ostream &os=std::cout) const {
    os << "identify yourself: SvxCentralTrackv7 object" << std::endl;
  }

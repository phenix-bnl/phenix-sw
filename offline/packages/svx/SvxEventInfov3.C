...
ClassImp(SvxEventInfov3)

// Constructor(s) & destructor
// """""""""""""""""""""""""""
SvxEventInfov3::SvxEventInfov3(SvxEventInfo* info)
  : SvxEventInfo(info)
{
  Reset();
}
...
void SvxEventInfov3::set_GlobalInfo (Event *e)
{
...
void SvxEventInfov3::set_pixelStatus (const int module, const int val)
{
...
void SvxEventInfov3::set_pixelStatus (const int module, Packet *p)
{
  if(!svxAddress::isPixelModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return;
...
void SvxEventInfov3::set_stripCellID (const int module, const int chip, const int val)
{
...
void SvxEventInfov3::set_stripStatus (const int module, const int val)
{
...
void SvxEventInfov3::set_stripStatus (const int module, Packet *p)
{
  if(!svxAddress::isStripModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return;
...
void SvxEventInfov3::set_pixelNRawhits(const int ladder, const int sensor, const int nrawhits)
{
...
void SvxEventInfov3::set_pixelNClusters(const int ladder, const int sensor, const int nclusters)
{
  if(ladder<0||ladder>=30||sensor<0||sensor>=4){
    cerr<<PHWHERE<<" out of range ladder/sensor:"<<ladder<<"/"<<sensor<<endl;
    return;
...
void SvxEventInfov3::set_stripNRawhits(const int module, const int nrawhits)
{
  if(!svxAddress::isPixelModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return;
...
void SvxEventInfov3::set_stripNClusters(const int module, const int nclusters)
{
  if(!svxAddress::isPixelModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return;
...
//get
int SvxEventInfov3::get_pixelStatus(const int module) const
{
  if(!svxAddress::isPixelModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return -9999;
...
int SvxEventInfov3::get_pixelSubsysStatus(const int module) const
{
  if(!svxAddress::isPixelModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return -9999;
...
int SvxEventInfov3::get_pixelDcmStatus(const int module) const
{
  if(!svxAddress::isPixelModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return -9999;
...
int SvxEventInfov3::get_pixelBeamClock(const int module) const
{
  if(!svxAddress::isPixelModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return -9999;
...
int SvxEventInfov3::get_pixelEventCount(const int module) const
{
  if(!svxAddress::isPixelModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return -9999;
...
int SvxEventInfov3::get_stripCellID(const int module, const int chip) const
{
  if(!svxAddress::isStripModuleID(module)||!(0<=chip&&chip<6)){
    cerr<<PHWHERE<<" out of range module:"<<module<<" chip:"<<chip<<endl;
    return -9999;
...
int SvxEventInfov3::get_stripStatus(const int module) const
{
  if(!svxAddress::isStripModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return -9999;
...
int SvxEventInfov3::get_stripSubsysStatus(const int module) const
{
  if(!svxAddress::isStripModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return -9999;
...
int SvxEventInfov3::get_stripDcmStatus(const int module) const
{
  if(!svxAddress::isStripModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return -9999;
...
int SvxEventInfov3::get_stripBeamClock(const int module) const
{
  if(!svxAddress::isStripModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return -9999;
...
int SvxEventInfov3::get_stripEventCount(const int module) const
{
  if(!svxAddress::isStripModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return -9999;
...
unsigned char SvxEventInfov3::get_pixelNRawhits(const int ladder, const int sensor) const
{
  if(ladder<0||ladder>=30||sensor<0||sensor>=4){
    cerr<<PHWHERE<<" out of range ladder/sensor:"<<ladder<<"/"<<sensor<<endl;
    return 0;
...
unsigned char SvxEventInfov3::get_pixelNClusters(const int ladder, const int sensor) const
{
  if(ladder<0||ladder>=30||sensor<0||sensor>=4){
    cerr<<PHWHERE<<" out of range ladder/sensor:"<<ladder<<"/"<<sensor<<endl;
    return 0;
...
unsigned char SvxEventInfov3::get_stripNRawhits(const int module) const
{
  if(!svxAddress::isStripModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return 0;
...
unsigned char SvxEventInfov3::get_stripNClusters(const int module) const
{
  if(!svxAddress::isStripModuleID(module)){
    cerr<<PHWHERE<<" out of range module:"<<module<<endl;
    return 0;

// ==================
// FILE: SvxCentralTrackv4.h
// ==================

#ifndef __SVXCENTRALTRACKV4_H_
#define __SVXCENTRALTRACKV4_H_
 ...
 *
 * Created on 04/14/2012 by Takashi Hachiya.
 */


class SvxCentralTrackv4 : public SvxCentralTrack
{
  public:
  ...
  public:
   ...
   virtual SvxResidualInfo* getSecondHit(int layer, int hit);
    ...
    virtual void identify(std::ostream &os=std::cout) const {
      os << "identify yourself: SvxCentralTrackv4 object" << std::endl;
    }

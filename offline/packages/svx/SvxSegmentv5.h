...
#ifndef __SVXSEGMENTV5_H_
#define __SVXSEGMENTV5_H_

#include "SvxSegment.h"
#include <cmath>

class SvxSegmentv5 : public SvxSegment
{

 public:

/**
  V5 implementation of the SVX(VTX) standalone track.

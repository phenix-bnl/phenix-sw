// ==================
// FILE: SvxCentralTrackv8.h
// ==================

#ifndef __SVXCENTRALTRACKV8_H_
#define __SVXCENTRALTRACKV8_H_
...
/**
 * @brief  The implementation v8 of SvxCentralTrack.
 *
...
class SvxCentralTrackv8 : public SvxCentralTrack
{
 public:
...
//--  virtual float getD2DCA0(){return m_DCA2D0;}
  ...
  virtual void identify(std::ostream &os=std::cout) const {
    os << "identify yourself: SvxCentralTrackv8 object" << std::endl;
  }

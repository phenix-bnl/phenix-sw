...
#ifndef __SVXCLUSTERV4_HH_
#define __SVXCLUSTERV4_HH_

#include "SvxCluster.h"
#include "SvxClusterList.h"

/**
 * Implementation class (version 4) of SvxCluster.
 ...
 */
class SvxClusterv4 : public SvxCluster
{
 ...
 public:
  ...
  // """""""""""""""""""""""""""
  SvxClusterv4(SvxClusterList* lst = NULL, SvxCluster* cluster = NULL);
  SvxClusterv4(SvxCluster*     cluster                               );
  virtual ~SvxClusterv4()
    {/*std::cout << "SvxClusterv4 object destroyed" << std::endl;*/}
  ...
  // Methods
  // """""""
  virtual SvxHit* Clone()           { return new SvxClusterv4(this); }

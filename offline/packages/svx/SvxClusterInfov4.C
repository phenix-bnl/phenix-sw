...
ClassImp(SvxClusterInfov4)



/**
 * @brief  The implementation v4 of SvxClusterInfo.
 *
 * Created on 1/18/2013 by Ryohji Akimoto.
 */

void SvxClusterInfov4::copy(const SvxClusterInfo& info)
{
//  cout<<"SvxClusterInfov4::copy"<<endl;

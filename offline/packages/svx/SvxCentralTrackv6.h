// ==================
// FILE: SvxCentralTrackv6.h
// ==================

#ifndef __SVXCENTRALTRACKV6_H_
#define __SVXCENTRALTRACKV6_H_

#include <SvxCentralTrack.h>
#include <SvxClusterInfov4.h>
#include <SvxResidualInfov1.h>

#include <iostream>

/**
 * @brief  The implementation v6 of SvxCentralTrack.
 *
 * Created on 04/28/2012 by Takashi Hachiya.
 */


class SvxCentralTrackv6 : public SvxCentralTrack
{
  public:
  ...
  public:
   ...
   virtual SvxResidualInfo* getSecondHit(int layer, int hit);
    ...
    virtual void identify(std::ostream &os=std::cout) const {
      os << "identify yourself: SvxCentralTrackv6 object" << std::endl;
    }
  ...
  protected:
    ...
    SvxClusterInfov4 m_vinfo[MAXCLUSTERS];

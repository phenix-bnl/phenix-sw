// ========================
// FILE: SvxClusterListv3.h
// ========================
// ****************************************************************************
// Container for the SvxClusterv3
...
#ifndef __SVXCLUSTERLISTV3_HH_
#define __SVXCLUSTERLISTV3_HH_

#include "TClonesArray.h"
#include "SvxClusterList.h"
#include "SvxClusterv3.h"

class SvxClusterListv3 : public SvxClusterList
{
 private:
 ...
 protected:
  ...
  bool          listPointersSet ; //! Each SvxClusterv3 knows list pointer
  int           m_hit_id_unused ; ///< Smallest hit ID not used.

  // Methods
  void restoreListPointers();     // Supply list pointer to each SvxClusterv3

 public:
  // Constructor(s) & destructor
  // """""""""""""""""""""""""""
  SvxClusterListv3(const unsigned int length = SVXNCLUSTER);
  virtual ~SvxClusterListv3();

// =======================
// FILE: SvxRawhitListv2.h
// =======================
// ****************************************************************************
// Container for the SvxRawhitv2
// ****************************************************************************

#ifndef __SVXRAWHITLISTV2_HH_
#define __SVXRAWHITLISTV2_HH_

#include "SvxRawhitList.h"
#include "TClonesArray.h"
#include "SvxRawhitv2.h"

class SvxRawhitListv2 : public SvxRawhitList
{
 private:
//  enum {SVXNRAWHIT = 20000};   //! Default initial size of Rawhit list
 ...
 protected:
  ...
  bool          listPointersSet ; //! Each SvxRawhitv2 knows list pointer
  int           m_hit_id_unused ; ///< Smallest hit ID not used.

  // Methods
  void SortSTL();
  void restoreListPointers();     // Supply list pointer to each SvxRawhitv2

 public:
  // Constructor(s) & destructor
  // """""""""""""""""""""""""""
  SvxRawhitListv2(const unsigned int length = SVXNRAWHIT);

  virtual ~SvxRawhitListv2();

  // Copy class
//  virtual SvxRawhitListv2* clone() const {
//    return new SvxRawhitListv2(*this);
//  }

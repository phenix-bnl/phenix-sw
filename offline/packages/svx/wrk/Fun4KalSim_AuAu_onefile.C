...
//
void Fun4KalSim_AuAu_onefile(
	       int nEvents=100,
               char *inputfile =  "/phenix/hl/data09/lebedev/newsim/pisa/pions_10kevts_00_nomuls.root",
               char *mergefile =  "/phenix/hl/data09/lebedev/newsim/pisa/pions_10kevts_00_nomuls.root",
	       char *outputfile = "/phenix/hl/data09/lebedev/newsim/simdst/test.root",
               Int_t magField=0,

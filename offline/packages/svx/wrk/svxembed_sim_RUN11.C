...
void svxembed_sim_RUN11(
  Int_t nEvents = 100,
  char *filein="PISAEvent.root",
  char *filemerge="PISAEvent.root",
  char *dstout = "simDST.root",
  int run_number = 347129
)
///
/// INPUT
...
//    manager->AddNode("emcghit");
    ...
    manager->AddNode("SvxMergedRawhitList");

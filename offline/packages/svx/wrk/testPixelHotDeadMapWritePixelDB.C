...
void testPixelHotDeadMapWritePixelDB()
{
  ...
  //
  //  cout << "Write chip map to DB: " << (writechipstat ? "success" : "failure")
  //       << endl;

  string pixelfilename("pixelmap/hotdeadpixel_0_0_346973_349680_test2.txt");
  //  string pixelfilename("pixelmap/hotdeadpixel_0_0_346973_349680_test1.txt");

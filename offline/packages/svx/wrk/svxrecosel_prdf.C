...
void svxrecosel_prdf
(
 //int nEvents=1000, 
 int nEvents=0, 
 char *inputfile="/phenix/scratch/lebedev/EVENTDATA_P00-0000347129-0004.PRDFF",
 char* outputfile="/phenix/scratch/lebedev/DST_0000347129-0004.root",
 int ppFlag = 0
)
///
/// INPUT
...
///   ppFlag     : ppFlag==0 for AuAu, ==1 for p+p
{
  ///////////////////////////////////////////
  // Load Libraries
  //////////////////////////////////////////
  ...
  rc->set_IntFlag("SVXACTIVE", 0); // not used
  ...
  if(ppFlag==0) bbc->setBbcVtxError( 0.5 );
  else          bbc->setBbcVtxError( 2.0 );
  ...
  if(ppFlag==0) rc->set_IntFlag("MPC_RECO_MODE",0x3);
  else          rc->set_IntFlag("MPC_RECO_MODE",0x1);
  ...
  if(ppFlag!=0) svxstandalone->setPPFlag(true);

//
// This is a macro to run svx reconstruction from pisa hits and reconstruct jets 
//
void svxjetreco(
   int nEvents = 20, 
   char *filein="/phenix/subsys/vtx/lebedev/phpythia/PISAEvent_jets_100kevts_110.root", 
   //char *filein="/phenix/subsys/vtx/lebedev/phpythia/PISAEvent_jets_1kevts_00.root", 
   char *fileout="/phenix/subsys/vtx/lebedev/phpythia/simDST_jets.root"
            )
{
  ...
  (dynamic_cast<SvxSimulator*>(svxsim))->set_ReadParFromFile(1);
...
//  (dynamic_cast<SvxSimulator*>(svxsim))->set_StripixelAdcSumThreshold(50);
  ...
  (dynamic_cast<SvxReco*>(svxrec))->set_ReadParFromFile(1);
  svxrec->Verbosity(0);
  se->registerSubsystem(svxrec);

  //SvxStandAloneReco *svxstandalone = new SvxStandAloneReco();
  SubsysReco *svxstandalone = new SvxStandAloneReco();
  (dynamic_cast<SvxStandAloneReco*>(svxstandalone))->setVerbosity(0);
  (dynamic_cast<SvxStandAloneReco*>(svxstandalone))->setVertexRecoFlag(2);
  se->registerSubsystem(svxstandalone);

  SubsysReco* svxjetreco1 = new SvxJetReco("anti-kt",0.7,"SVXJetsAntiKt07");
  se->registerSubsystem(svxjetreco1);
  SubsysReco* svxjetreco2 = new SvxJetReco("anti-kt",0.7,"SVXJetsKt07");
  se->registerSubsystem(svxjetreco2);
  ...
  simDST->AddNode("SVXJetsAntiKt07");
  simDST->AddNode("SVXJetsKt07");

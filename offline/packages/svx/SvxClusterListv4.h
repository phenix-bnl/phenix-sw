// ========================
// FILE: SvxClusterListv4.h
// ========================
// ****************************************************************************
// Container for the SvxClusterv4
...
#ifndef __SVXCLUSTERLISTV4_HH_
#define __SVXCLUSTERLISTV4_HH_

#include "TClonesArray.h"
#include "SvxClusterList.h"
#include "SvxClusterv4.h"

class SvxClusterListv4 : public SvxClusterList
{
 private:
 ...
 protected:
  ...
  bool          listPointersSet ; //! Each SvxClusterv4 knows list pointer
  int           m_hit_id_unused ; ///< Smallest hit ID not used.

  // Methods
  void restoreListPointers();     // Supply list pointer to each SvxClusterv4

 public:
  // Constructor(s) & destructor
  // """""""""""""""""""""""""""
  SvxClusterListv4(const unsigned int length = SVXNCLUSTER);
  virtual ~SvxClusterListv4();

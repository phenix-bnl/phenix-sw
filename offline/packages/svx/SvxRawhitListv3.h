// =======================
// FILE: SvxRawhitListv3.h
// =======================
// ****************************************************************************
// Container for the SvxRawhitv3
// ****************************************************************************

#ifndef __SVXRAWHITLISTV3_HH_
#define __SVXRAWHITLISTV3_HH_

#include "SvxRawhitList.h"
#include "TClonesArray.h"
#include "SvxRawhitv3.h"

class SvxRawhitListv3 : public SvxRawhitList
{
 private:
//  enum {SVXNRAWHIT = 20000};   //! Default initial size of Rawhit list
 ...
 protected:
  ...
  bool          listPointersSet ; //! Each SvxRawhitv3 knows list pointer
  int           m_hit_id_unused ; ///< Smallest hit ID not used.

  // Methods
  void SortSTL();
  void restoreListPointers();     // Supply list pointer to each SvxRawhitv3

 public:
  // Constructor(s) & destructor
  // """""""""""""""""""""""""""
  SvxRawhitListv3(const unsigned int length = SVXNRAWHIT);

  virtual ~SvxRawhitListv3();

  // Copy class
//  virtual SvxRawhitListv3* clone() const {
//    return new SvxRawhitListv3(*this);
//  }
...
//		     const int        iupto =-1) const;
  ...
  //---
  ClassDef(SvxRawhitListv3,1)
};
#endif /* __SVXRAWHITLISTV2_HH_ */

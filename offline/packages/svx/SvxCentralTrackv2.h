// ==================
// FILE: SvxCentralTrackv2.h
// ==================

#ifndef __SVXCENTRALTRACKV2_H_
#define __SVXCENTRALTRACKV2_H_
 ...
 *
 * Created on 02/17/2012 by Takashi Hachiya.
 */


class SvxCentralTrackv2 : public SvxCentralTrack
{
  enum {MAXCLUSTERS = 6};

  public:
    SvxCentralTrackv2();
    virtual ~SvxCentralTrackv2() {}
    ...
    virtual void identify(std::ostream &os=std::cout) const {
      os << "identify yourself: SvxCentralTrackv2 object" << std::endl;
    }

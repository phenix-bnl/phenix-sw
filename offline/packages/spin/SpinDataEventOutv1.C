...
#include "SpinDataEventOutv1.h"

ClassImp(SpinDataEventOutv1)
//________________________________________________________________________________

SpinDataEventOutv1::SpinDataEventOutv1()
{ 
  Reset(); 
}
//________________________________________________________________________________
...
void SpinDataEventOutv1::Reset()
{
  ...
  SpinDirectionBlueFromCDEVFillPattern = 0;
  SpinDirectionYellowFromCDEVFillPattern = 0;

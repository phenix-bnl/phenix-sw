...
ClassImp(emcClusterContentv3)

  using namespace std;

//_____________________________________________________________________________
emcClusterContentv3::emcClusterContentv3() :
  fTowerid(0),
  fPartesum(0)
{
  Reset();
...
//_____________________________________________________________________________
emcClusterContentv3::emcClusterContentv3(const emcClusterContentv3& to)
  : fTowerid(0),
    fPartesum(0)
{
  to.copy(*this);
...
//_____________________________________________________________________________
emcClusterContentv3&
emcClusterContentv3::operator=(const emcClusterContentv3& to)
{
  if ( this != &to ) 
    {
      Reset();
...
{
  return new emcClusterContentv3(*this);
}
...
{
  return new emcClusterContentv3;
}
...
//_____________________________________________________________________________
void emcClusterContentv3::Clear(Option_t*)
{
  delete[] fPartesum;
  fPartesum=0;
  delete[] fTowerid;
...
//_____________________________________________________________________________
void
emcClusterContentv3::copy(emcClusterContentv3& to) const
{
...
//_____________________________________________________________________________
void
emcClusterContentv3::identify(std::ostream& os) const
{
  os << "emcClusterContentv3::identify" << endl;
}

//_____________________________________________________________________________
int
emcClusterContentv3::isValid() const
{
  return 1;
} 
...
//_____________________________________________________________________________
float
emcClusterContentv3::partesum(int index) const
{
  if (index>=0 && index<fMultiplicity)
    ...
    {
      cerr << "emcClusterContentv3::partesum : index out of bounds ("
...
//_____________________________________________________________________________
void
emcClusterContentv3::print(std::ostream& out) const
{ 
...
//_____________________________________________________________________________
int
emcClusterContentv3::towerid(int index) const
{
  if (index>=0 && index<fMultiplicity)
    {
    ...
    {
      cerr << "emcClusterContentv3::towerid : index out of bounds ("
	   << index << " out of " << fMultiplicity << ")" << endl;
      return 0;
    }
}
...
//_____________________________________________________________________________
void
emcClusterContentv3::set_multiplicity(int mul)
{
  fMultiplicity=mul;
...
//_____________________________________________________________________________
void
emcClusterContentv3::set_partesum(int index, float value)
{
  if ( !fPartesum ) 
    {
      cerr << "emcClusterContentv3::set_partesum : internal array is null."
  ...
  if (index>=0 && index<fMultiplicity)
    ...
    {
      cerr << "emcClusterContentv3::set_partesum : index out of bounds ("
	   << index << " out of " << fMultiplicity << ")" << endl;
    }
}
...
//_____________________________________________________________________________
void
emcClusterContentv3::set_towerid(int index, int value)
{ 
  if ( !fTowerid ) 
    {
      cerr << "emcClusterContentv3::set_towerid : internal array is null."
	   << " Did you forgot to specify the multiplicity ?"
	   << endl;
      return;
    }
  ...
  if (index>=0 && index<fMultiplicity)
    ...
    {
      cerr << "emcClusterContentv3::set_towerid : index out of bounds ("
	   << index << " out of " << fMultiplicity << ")" << endl;
    }
}

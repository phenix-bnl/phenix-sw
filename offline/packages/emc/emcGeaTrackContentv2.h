#ifndef __EMC_GEATRACK_V2_H__
#define __EMC_GEATRACK_V2_H__
...
class emcGeaTrackContentv2: public emcGeaTrackContent {
public:
  /// default constructor
  emcGeaTrackContentv2(emc_trkno_t thetrkno = EMC_INVALID_TRKNO);

  /// copy constructor
  emcGeaTrackContentv2(const emcGeaTrackContentv2 & t);

  /// destructor
  ~emcGeaTrackContentv2(){ Reset(); }

  //  virtual void copy(emcGeaTrackContent const * from);


public: /* standard PHObject stuff */
  emcGeaTrackContentv2 * clone() const { return new emcGeaTrackContentv2(*this); }
...
public: /* emcGeadDepositHolder stuff */
  ...
  // noop: all cached data is based on data belongig no this object,
  // cache is updated as soon as data is modified.
...
public:
  ...
  emc_towerlist_t ctowerlist; // cache for get_tower_list()
...
public:
  ...
  ClassDef(emcGeaTrackContentv2, 1)
};

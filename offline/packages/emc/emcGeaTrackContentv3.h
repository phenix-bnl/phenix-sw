#ifndef __EMC_GEATRACK_V3_H__
#define __EMC_GEATRACK_V3_H__
...
class emcGeaTrackContentv3: public emcGeaTrackContent {
public:
  /// default constructor
  emcGeaTrackContentv3(emc_trkno_t thetrkno = EMC_INVALID_TRKNO);

  /// copy constructor
  emcGeaTrackContentv3(const emcGeaTrackContentv3 & t);

  /// destructor
  ~emcGeaTrackContentv3(){ Reset(); }

  //  virtual void copy(emcGeaTrackContent const * from);


public: /* standard PHObject stuff */
  emcGeaTrackContentv3 * clone() const { return new emcGeaTrackContentv3(*this); }
...
public:
  ...
  ClassDef(emcGeaTrackContentv3, 1)
};

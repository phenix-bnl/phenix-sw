#ifndef __emcClusterContentv1M_h__
#define __emcClusterContentv1M_h__

#include "emcClusterContent.h"

/** (VERSION) For merged clusters coming from embedding. 

Is a superset of informations from real and simulated cluster information.
Characteristic point is that simfrac() should be > 0 and < 1.

*/

class emcClusterContentv1M : public emcClusterContent
{
public:
  ...
  emcClusterContentv1M& operator=(const emcClusterContentv1M&);
...
private:
  ...
  ClassDef(emcClusterContentv1M,1) // EMCAL Cluster content (might be a merged one)
};

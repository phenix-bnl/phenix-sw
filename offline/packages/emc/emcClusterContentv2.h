#ifndef __emcClusterContentv2_h__
#define __emcClusterContentv2_h__

#include "emcClusterContent.h"

/** (VERSION) emcClusterContent version 2. */

class emcClusterContentv2 : public emcClusterContent
{
public:

  /// CREATORS.
  emcClusterContentv2();
  emcClusterContentv2(const emcClusterContentv2&);
  emcClusterContentv2& operator=(const emcClusterContentv2&);

  emcClusterContentv2* clone(void) const;
  emcClusterContentv2* create(void) const;

  virtual ~emcClusterContentv2();
...
private:
  ...
  void copy(emcClusterContentv2& to) const;
...
private:
  ...
  ClassDef(emcClusterContentv2,1) // EMCAL Cluster content version 2
};

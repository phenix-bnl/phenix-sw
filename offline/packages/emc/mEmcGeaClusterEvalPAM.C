...
PHBoolean
mEmcGeaClusterEvalModule::callPAM(PHPointerList<PHNode> &nl) {
  long result;
  ...
  dEmcClusterLocalExtNode_t* n4 = static_cast<dEmcClusterLocalExtNode_t*>(nl[3]);

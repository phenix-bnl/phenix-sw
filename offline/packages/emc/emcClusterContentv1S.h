#ifndef __emcClusterContentv1S_h__
#define __emcClusterContentv1S_h__

#include "emcClusterContent.h"

/** (VERSION) For simulated clusters. 

simfrac() is always 1.0

*/

class emcClusterContentv1S : public emcClusterContent
{
public:

  /// CREATORS.
  emcClusterContentv1S();
  emcClusterContentv1S(const emcClusterContentv1S&);
  emcClusterContentv1S& operator=(const emcClusterContentv1S&);

  emcClusterContentv1S* clone(void) const;
  emcClusterContentv1S* create(void) const;

  virtual ~emcClusterContentv1S();
  ...
  void set_simfrac(float frac) { fSimFrac=frac; }
...
private:
  ...
  void copy(emcClusterContentv1S& to) const;
...
private:
  ...
  ClassDef(emcClusterContentv1S,1) // EMCAL Cluster content version 1 (simulation)
};

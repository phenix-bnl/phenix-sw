#include "emcClusterContentv1S.h"

ClassImp(emcClusterContentv1S)

  using namespace std;

//_____________________________________________________________________________
emcClusterContentv1S::emcClusterContentv1S() :
  fTowerid(0),
  fPartesum(0)
{
  Reset();
...
//_____________________________________________________________________________
emcClusterContentv1S::emcClusterContentv1S(const emcClusterContentv1S& to)
  : fTowerid(0),
    fPartesum(0)
{
  to.copy(*this);
...
//_____________________________________________________________________________
emcClusterContentv1S&
emcClusterContentv1S::operator=(const emcClusterContentv1S& to)
{
  if ( this != &to ) 
    {
      Reset();
...
//_____________________________________________________________________________
emcClusterContentv1S*
emcClusterContentv1S::clone(void) const
{
  return new emcClusterContentv1S(*this);
}

//_____________________________________________________________________________
emcClusterContentv1S*
emcClusterContentv1S::create(void) const
{
  return new emcClusterContentv1S;
}
...
//_____________________________________________________________________________
void emcClusterContentv1S::Clear(Option_t*)
{
  delete[] fPartesum;
  fPartesum=0;
  delete[] fTowerid;
...
//_____________________________________________________________________________
void
emcClusterContentv1S::copy(emcClusterContentv1S& to) const
{
...
//_____________________________________________________________________________
void
emcClusterContentv1S::identify(std::ostream& os) const
{
  os << "emcClusterContentv1S::identify" << endl;
}

//_____________________________________________________________________________
int
emcClusterContentv1S::isValid() const
{
  return 1;
} 
...
//_____________________________________________________________________________
float
emcClusterContentv1S::partesum(int index) const
{
  if (index>=0 && index<fMultiplicity)
    ...
    {
      cerr << "emcClusterContentv1S::partesum : index out of bounds ("
...
//_____________________________________________________________________________
void
emcClusterContentv1S::print(std::ostream& out) const
{ 
...
//_____________________________________________________________________________
int
emcClusterContentv1S::towerid(int index) const
{
  if (index>=0 && index<fMultiplicity)
    {
    ...
    {
      cerr << "emcClusterContentv1S::towerid : index out of bounds ("
	   << index << " out of " << fMultiplicity << ")" << endl;
      return 0;
    }
}
...
//_____________________________________________________________________________
void
emcClusterContentv1S::set_multiplicity(int mul)
{
  fMultiplicity=mul;
...
//_____________________________________________________________________________
void
emcClusterContentv1S::set_partesum(int index, float value)
{
  if ( !fPartesum ) 
    {
      cerr << "emcClusterContentv1S::set_partesum : internal array is null."
  ...
  if (index>=0 && index<fMultiplicity)
    ...
    {
      cerr << "emcClusterContentv1S::set_partesum : index out of bounds ("
	   << index << " out of " << fMultiplicity << ")" << endl;
    }
}
...
//_____________________________________________________________________________
void
emcClusterContentv1S::set_towerid(int index, int value)
{ 
  if ( !fTowerid ) 
    {
      cerr << "emcClusterContentv1S::set_towerid : internal array is null."
	   << " Did you forgot to specify the multiplicity ?"
	   << endl;
      return;
    }
  ...
  if (index>=0 && index<fMultiplicity)
    ...
    {
      cerr << "emcClusterContentv1S::set_towerid : index out of bounds ("
	   << index << " out of " << fMultiplicity << ")" << endl;
    }
}

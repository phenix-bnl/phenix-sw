#ifndef __EMC_GEATOWER_CONTENT_V5_H__
#define __EMC_GEATOWER_CONTENT_V5_H__
...
class emcGeaTowerContentv5: public emcGeaTowerContent {
public:
  emcGeaTowerContentv5(emc_towerid_t towerid = EMC_INVALID_TOWERID);
  emcGeaTowerContentv5(const emcGeaTowerContentv5 & t);
  virtual ~emcGeaTowerContentv5(){}
  
  
   // standard PHObject stuff
public:
  virtual emcGeaTowerContentv5 * clone() const { return new emcGeaTowerContentv5(*this); }
  virtual void Reset();
...
public:
  ...
  emc_tracklist_t const get_track_list() const;
  emc_clusterlist_t const get_cluster_list() const;
...
protected:
  ...
  mutable bool cacheok; //! are caches set up?
  mutable emc_tracklist_t ctracklist; //! cache for get_cluster_list()
  mutable emc_clusterlist_t cclusterlist; //! cache for get_cluster_list()
 
  ClassDef(emcGeaTowerContentv5, 1)
};
...
#endif /* ! __EMC_GEATOWER_CONTENT_V5_H__ */

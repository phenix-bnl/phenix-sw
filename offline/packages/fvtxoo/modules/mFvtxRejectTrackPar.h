#ifndef __MFVTXREJECTTRACKPAR_HH__
#define __MFVTXREJECTTRACKPAR_HH__
...
/*!
Runtime parameter object for mFvtxRejectTrack analysis module
*/
class mFvtxRejectTrackPar : public TFvtxParBase
{
  ...
  */
  ...
  void print(std::ostream& out = std::cout) const {
    MUTOO::PRINT(out, "mFvtxRejectTrackPar");
  ...
  */
  ...
  ClassDef(mFvtxRejectTrackPar, 1);
};

#endif /* __MFVTXREJECTTRACKPAR_HH__ */

// $Id: FvtxGeom_Test.C,v 1.1 2013/10/16 22:34:22 jinhuang Exp $                                                                                             
...
//
  TFvtxDatabaseCntrl::set_flag("geom_use_calibration_database", false);
  TFvtxDatabaseCntrl::set_filename("geom_root_file_path","/direct/phenix+subsys+fvtx/jinhuang/miliped_work/Run13_Station_Iter1_Wedge_Iter2/");
  TFvtxDatabaseCntrl::set_filename("geom_root_file_name",
...
SaveRun12Geom_Sim()
{
  ...
  FvtxGeom::save_pdb_geometry(begin, end, "Ideal geometry w/cage survey for run12 simulation",

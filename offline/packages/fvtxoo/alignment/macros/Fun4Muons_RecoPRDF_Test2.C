// $Id: Fun4Muons_RecoPRDF_Test2.C,v 1.1 2013/10/16 22:34:22 jinhuang Exp $
/*!
...
//    int nEvents = 100000000, //
    string input_file =
//        "/direct/phenix+subsys+fvtx/jinhuang/zero_field/ZEROFDATA_P00-0000368800-0002.PRDFF", //
        "/phenix/u/jinhuang/work/FVTX/data/fvtx_data/GoldenDimuon/run_0000367000_0000368000/GOLDENEVENT_DIMUON_run12_online_muon-0000367033-0000.PRDFF",
//    string input_file = "RunList", //
    char *dstfile = "DST.root", //
    bool UseVTXForFVTX = true,
    bool IncMuTr = true
    )
{

  cout << "Fun4Muons_RecoPRDF - alignment filtering script "
      <<" with UseVTXForFVTX =" << UseVTXForFVTX
      <<" and IncMuTr =" << IncMuTr
      <<endl;

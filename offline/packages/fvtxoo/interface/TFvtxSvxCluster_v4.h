#ifndef __TFvtxSvxCluster_v4_h__
#define __TFvtxSvxCluster_v4_h__

// $Id: TFvtxSvxCluster_v4.h,v 1.1 2012/10/01 04:28:01 keyaaron Exp $

/*!
   \file TFvtxSvxCluster_v4.h
...
class TFvtxSvxCluster_v4 : public TFvtxSvxCluster 
{
  
public:
  
  //! shortcut to SvxSngSvxCluster implementation
  typedef SvxClusterv4 value_type;
  ...
  //! Construct with key
  TFvtxSvxCluster_v4(const Key& key, const unsigned short& index);
 
  //! Construct from base class
  TFvtxSvxCluster_v4(const TFvtxSvxCluster& base_ref);
  
  //! Construct from base class
  TFvtxSvxCluster_v4(const TFvtxSvxCluster* base_pointer);

  //! Default
  virtual ~TFvtxSvxCluster_v4() {}

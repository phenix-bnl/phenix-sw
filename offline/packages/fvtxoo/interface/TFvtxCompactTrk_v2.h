...
class TFvtxCompactTrk_v2 : public TFvtxCompactTrk
{
  ...
  //! destructor
  virtual ~TFvtxCompactTrk_v2(){;}
  
  //! constructor
  TFvtxCompactTrk_v2(const Key&,
  ...
  //! constructor 
  TFvtxCompactTrk_v2(const TFvtxCompactTrk* base_ptr);

  //! constructor 
  TFvtxCompactTrk_v2(const TFvtxCompactTrk& base_ref);

  //! constructor from TFvtxTrk
  TFvtxCompactTrk_v2(const TFvtxTrk* base_ptr);
  ...
  ClassDef(TFvtxCompactTrk_v2,1)
};

#endif /* __TFVTXCompactTrk_v2H__*/

#ifndef MCEVALSINGLELIST_v2_H
#define MCEVALSINGLELIST_v2_H
...
class McEvalSingleList_v2 : public McEvalSingleList
{
 public:
  McEvalSingleList_v2();
  virtual ~McEvalSingleList_v2();
...
protected: 
  ...
  ClassDef(McEvalSingleList_v2,1)
};

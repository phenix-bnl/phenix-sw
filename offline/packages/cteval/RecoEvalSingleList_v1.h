#ifndef RECOEVALSINGLELIST_v1_H
#define RECOEVALSINGLELIST_v1_H
...
class RecoEvalSingleList_v1 : public RecoEvalSingleList
{
  public:
  
  //! constructor
  RecoEvalSingleList_v1();

  //! destructor
  virtual ~RecoEvalSingleList_v1();
...
protected: 
  ...
  ClassDef(RecoEvalSingleList_v1,1)
};

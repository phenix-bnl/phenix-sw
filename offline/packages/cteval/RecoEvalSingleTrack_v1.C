...
ClassImp(RecoEvalSingleTrack_v1)

void RecoEvalSingleTrack_v1::Init()
{
  RECOID      = -999;
  QUALITY     = -999;
  MOMENTUM    = -999;
...
RecoEvalSingleTrack_v1::RecoEvalSingleTrack_v1()
{
  Init();
}

RecoEvalSingleTrack_v1::RecoEvalSingleTrack_v1(RecoEvalSingleTrack *track)
{
  Init();
  if(!track) return;

#ifndef RECOEVALSINGLETRACK_v1_H
#define RECOEVALSINGLETRACK_v1_H

#include "PHObject.h"
#include "RecoEvalSingleTrack.h"

class RecoEvalSingleTrack_v1 : public RecoEvalSingleTrack
{
public:
  RecoEvalSingleTrack_v1();
  RecoEvalSingleTrack_v1(RecoEvalSingleTrack *track);  
  virtual ~RecoEvalSingleTrack_v1(){};
...
protected:
  ...
  ClassDef(RecoEvalSingleTrack_v1,1)
};

#endif /*__RECOEVALSINGLETRACK_v1_H*/

#ifndef MCEVALSINGLETRACK_v1_H
#define MCEVALSINGLETRACK_v1_H
...
class McEvalSingleTrack_v1 : public McEvalSingleTrack
{
public:
  
  //! constructor
  McEvalSingleTrack_v1();

  //! copy constructor
  McEvalSingleTrack_v1(McEvalSingleTrack *track);  

  virtual ~McEvalSingleTrack_v1();

  void set_eventid(int val) 
  {EVENTID = val;}
...
protected:
  ...
  short MCTRACKID;
  short GENERATION;
  short PARTICLEID, PARENTID, PRIMARYID;
  ...
  ClassDef(McEvalSingleTrack_v1,1)
};

#endif /*__MCEVALSINGLETRACK_v1_H*/

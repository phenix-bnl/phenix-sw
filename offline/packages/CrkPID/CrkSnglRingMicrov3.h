#ifndef __CRKSNGLRINGMicrov3_H
#define __CRKSNGLRINGMicrov3_H

#include "PHObject.h"

class CrkSnglRingMicrov3 : public TObject
{
 public:
  CrkSnglRingMicrov3();  
  virtual ~CrkSnglRingMicrov3() {}
  ...
  short get_npmt2() const {return npmt2;}
  void set_npmt2(const short ival) {npmt2 = ival; return;}
  ...
  void set_npe2(const float rval) {npe2 = rval; return;}
  ...
  void set_tcrk(const float rval) {tcrk = rval; return;}
 ...
 protected:
  ...
  ClassDef(CrkSnglRingMicrov3,1)
};

#endif /* __CRKSNGLRINGMicrov3_H */

#ifndef __CRKRINGMICROV4_H
#define __CRKRINGMICROV4_H
...
class CrkRingMicrov4 : public CrkRing
{
 public:
  CrkRingMicrov4();
  virtual ~CrkRingMicrov4();
 ...
 protected:
  TClonesArray *GetCrkRing() const {return CrkRings;}
  unsigned int CrkNRing;
  TClonesArray *CrkRings;
  ClassDef(CrkRingMicrov4,1)

};

#endif /* __CRKRINGMICROV4_H */

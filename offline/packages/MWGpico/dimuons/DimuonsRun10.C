// $Id: DimuonsRun10.C,v 1.4 2010/02/23 20:03:13 hpereira Exp $
...
void MWGpico::BookDimuonsNtupleRun10( TNtuple*& dimuons, TString name, TString title )
{

  MUTOO::PRINT( cout, "MWGpico::BookDimuonsNtupleRun10" );
...
//_________________________________________________________________
int MWGpico::FillDimuonsRun10(PHMuoTracksOut* &muo, TNtuple* dimuons)
{
  if( verbosity >= 2 ) cout << "MWGpico::FillDimuonsRun10" << endl;
  ...
  accEVT++;
  if( verbosity >= 2 ) cout << "MWGpico::FillDimuonsRun10 - done." << endl;
  return 0;
}

// $Id: DimuonsRun8.C,v 1.12 2013/01/15 16:15:57 sar Exp $
...
void MWGpico::BookDimuonsNtupleRun8( TNtuple*& dimuons, TString name, TString title )
{

  MUTOO::PRINT( cout, "MWGpico::BookDimuonsNtupleRun8" );
  ...
  const char* varlist  =
    ...
    "xF:x1:x2:costhCS:Tr0_chi2:Tr1_chi2:Tr0_px:Tr0_py:Tr0_pz:Tr1_px:" //20
    "Tr1_py:Tr1_pz:Tr0_idhits:Tr1_idhits:Tr0_idquad:Tr1_idquad:Tr0_lastGap:Tr1_lastGap:Tr0_trhits:Tr1_trhits:" //10

    "Tr0_DS3:Tr1_DS3:Tr0_DS3ctp:Tr1_DS3ctp:Evt_vtxchi2:Evt_vtxooz:Tr0_idchi2:Tr1_idchi2:Tr0_DG0:Tr1_DG0:" //10

    "Tr0_DDG0:Tr1_DDG0:Evt_vtxoor:Evt_l2S:Evt_l2N:dca:xvtxbp:yvtxbp:zvtxbp:Tr0_DG0x:" //10

    "Tr0_DG0y:Tr1_DG0x:Tr1_DG0y:MuIDlevel2ok:MuIDl2primitiveok:Evt_ll1_S2D:Evt_ll1_N2D:Evt_pseudoll1_S2D:Evt_pseudoll1_N2D:mutr_hits_south:" //10

    "mutr_hits_north:zvtx_dimu:Evt_ll1_S1D:Evt_ll1_N1D:Evt_pseudoll1_S1D:Evt_pseudoll1_N1D" //6
    ;
  //! create the ntuple
...
//_________________________________________________________________
int MWGpico::FillDimuonsRun8(PHMuoTracksOut* &muo, TNtuple* dimuons)
{
  if( verbosity >= 2 ) cout << "MWGpico::FillDimuonsRun8" << endl;
  ...
  if( !(_choice == "simu" || _choice == "simu_file") )
  {
    ...
    ll1_2D_south = trigger_helper.trigScaled( "MUIDLL1_S2D&BBCLL1" );
    ll1_2D_north = trigger_helper.trigScaled( "MUIDLL1_N2D&BBCLL1" );

    ll1_1D_south = trigger_helper.trigScaled( "MUIDLL1_S1D&BBCLL1" );
    ll1_1D_north = trigger_helper.trigScaled( "MUIDLL1_N1D&BBCLL1" );
  ...
  if (muo) {
	...
	for(int igap1=4; igap1>0; igap1--)
      ...
      varNT[55] = ll1_2D_south;
      varNT[56] = ll1_2D_north;
      varNT[57] = pseudoll1_2D_south;
      varNT[58] = pseudoll1_2D_north;

      varNT[59] = mutr_hits_south;
      varNT[60] = mutr_hits_north;
      varNT[61] = zvtx_dimu;

      varNT[62] = ll1_1D_south;
      varNT[63] = ll1_1D_north;
      varNT[64] = pseudoll1_1D_south;
      varNT[65] = pseudoll1_1D_north;

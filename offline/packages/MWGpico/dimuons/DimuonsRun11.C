// $Id: DimuonsRun11.C,v 1.2 2011/05/23 07:15:17 rseidl Exp $
...
void MWGpico::BookDimuonsNtupleRun11( TNtuple*& dimuons, TString name, TString title )
{

  MUTOO::PRINT( cout, "MWGpico::BookDimuonsNtupleRun11" );

  /* to make counting of variables easier, please try to write only ten variables/lines */
  const char* varlist  =
    "Run_Number:Evt_Number:Evt_Nmu:Evt_bbcZ:Evt_bbcCentrality:Evt_bbcChargeS:Evt_bbcChargeN:trigger:mass:charge:rapidity:"
...
//_________________________________________________________________
int MWGpico::FillDimuonsRun11(PHMuoTracksOut* &muo, TNtuple* dimuons)
{
  if( verbosity >= 2 ) cout << "MWGpico::FillDimuonsRun11" << endl;
  ...
  if (muo) {
    ...
    for (int idimu=0; idimu<ndimu; idimu++)
    {
      ...
      varNT[8] = dimass;
      varNT[9] = dicharge;
      varNT[10] = Tools::rapidity( dimass, &diP[0] );

      varNT[11] = Tools::pT( &diP[0] );
      varNT[12] = Tools::p( &diP[0] );
      varNT[13] = Tools::xF( dimass, &diP[0], E_CMS );
      varNT[14] = Tools::x1( dimass, &diP[0], E_CMS );
      varNT[15] = Tools::x2( dimass, &diP[0], E_CMS );
      varNT[16] = Tools::costhetaCS(Const::MUMASS, &P0[0], &P1[0] );
      varNT[17] = chi0;
      varNT[18] = chi1;
      varNT[19] = P0[0];
      varNT[20] = P0[1];
      ...
      varNT[33] = dS3ctp0;
      varNT[34] = dS3ctp1;
      varNT[35] = muo->get_vtx_chisquare(idimu);
      varNT[36] = muo->get_vtx_zpos(idimu);
      varNT[37] = muIDchis0;
      varNT[38] = muIDchis1;
      varNT[39] = dG00;
      varNT[40] = dG01;
      ...
      varNT[41] = ddG00;
      varNT[42] = ddG01;
      varNT[43] =  sqrt( MUTOO::SQUARE( muo->get_vtx_xpos(idimu) ) + MUTOO::SQUARE( muo->get_vtx_ypos(idimu) ) );
      varNT[44] = l2_south;
      varNT[45] = l2_north;
      varNT[46] = dca_bp;
      varNT[47] = xvtx_bp;
      varNT[48] = yvtx_bp;
      varNT[49] = zvtx_bp;
      varNT[50] = Tools::DG0x(muo,idx0, iroad0 );

      varNT[51] = Tools::DG0y(muo,idx0, iroad0 );
      varNT[52] = Tools::DG0x(muo,idx1, iroad1 );
      varNT[53] = Tools::DG0y(muo,idx1, iroad1 );
      varNT[54] = Tools::L2MuID_dimuOK( idx0, iroad0, idx1, iroad1, muo, MWGpico::RUN4);
      varNT[55] = Tools::L2MuidPairOK(idimu,muo);
      varNT[56] = mutr_hits_south;
      varNT[57] = mutr_hits_north;
      varNT[58] = rp_south;
      varNT[59] = rp_north;
      varNT[60] = rp_both;
  ...
  accEVT++;
  if( verbosity >= 2 ) cout << "MWGpico::FillDimuonsRun11 - done." << endl;
  return 0;
}

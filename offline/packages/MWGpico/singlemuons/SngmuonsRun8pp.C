// $Id: SngmuonsRun8pp.C,v 1.6 2014/12/09 06:28:10 rseidl Exp $
...
void MWGpico::BookSngmuonsNtupleRun8pp(TNtuple*& sngmuons, TString m_name, TString m_title)
{
...
void MWGpico::BookSngmuonsEvtNtupleRun8pp(TNtuple*& sngvtx, TString v_name, TString v_title )
{
...
//__________________________________________________
int MWGpico::FillSngmuonsNtpRun8pp(PHMuoTracksOut* &muo, TNtuple* sngmuons,  TNtuple* sngvtx)
{
  //=== event selection

// $Id: SngmuonsRun12CuAu.C,v 1.3 2014/12/15 05:46:27 rseidl Exp $

/*!
   \file SngmuonsRun3.C
   \brief single muon ntuple booking and feeling
   \version $Revision: 1.3 $
   \date $Date: 2014/12/15 05:46:27 $
*/
...
void MWGpico::BookSngmuonsNtupleRun12CuAu(TNtuple*& sngmuons, TString m_name, TString m_title)
{
  ...
  */
  ...
  if ( _choice == "simu" ){
	  sngvarlist=
		...
		"muid_nhits:Evt_realtrig_BBCLL1:Evt_realtrig_BBCLL1_narrowvtx:"
		"Evt_realtrig_BBCLL1_narrowvtx_CopyA:Evt_realtrig_BBCLL1_narrowvtx_CopyB:" //45
		"Evt_realtrig_BBCLL1_novtx:xSt1:"//47
		"ySt1:zSt1:xSt2:ySt2:zSt2:" //52
		"xSt3:ySt3:zSt3:ref_vtx_rdca:ref_vtx_r:" //57
		"ref_vtx_z:refit_zvtx:Clock_trig:Evt_realtrig_MB:dAngle:" //62
		"dAngle_xyz:dTheta:dPhi:road_slope:vtx_chi2:vtx_chi2pdf:" //68
      	        "RPbbcrp10:RPbbcrp11:RPbbcrp12:RPbbcrp00:RPbbcrp01:RPbbcrp02:" //74
		"mc_n_part:mc_px:mc_py:mc_pz:mc_ptot:mc_z:" //80
		"mc_pid:mc_hits:mc_p_pid:mc_p_px:mc_p_py:" //85
		"mc_p_pz:mc_p_ptot:mc_p_z:mc_d_pid:mc_d_px:" //90
		"mc_d_py:mc_d_pz:mc_d_ptot:mc_d_z:mc_d_n:" //95
		"mc_x:mc_y:mc_g_pid:mc_g_px:mc_g_py:" //100
	        "mc_g_pz:mc_g_ptot:mc_g_z:mc_trk"; //104
	  //    "sng_v2_S:sng_v2_N:sng_v2"; //107
  }else{
	  sngvarlist=
		"Run_Number:Evt_Number:Evt_Nmu:Evt_Z:Evt_bbcZ:" //5
		"Evt_bbcCentrality:Evt_zdcEnerN:charge:px:py:" //10
...
void MWGpico::BookSngmuonsEvtNtupleRun12CuAu(TNtuple*& sngvtx, TString v_name, TString v_title )
{
  ...
  vtxvarlist= "Run_Number:Evt_Z:bbcZ:zdcCentrality:bbcCentrality:" //5
	...
	"ZDCS:Clock_trig:Evt_realtrig_MB:Evt_realtrig_BBCLL1:Evt_realtrig_BBCLL1_narrowvtx:" //15
	"Evt_realtrig_BBCLL1_narrowvtx_CopyA:Evt_realtrig_BBCLL1_narrowvtx_CopyB:"
	"Evt_realtrig_BBCLL1_novtx:Evt_livetrig_BBCLL1:Evt_livetrig_BBCLL1_narrowvtx:" //20
	"Evt_livetrig_BBCLL1_narrowvtx_CopyA:Evt_livetrig_BBCLL1_narrowvtx_CopyB:"
	"Evt_livetrig_BBCLL1_novtx:" //23
        "RPbbcrp10:RPbbcrp11:RPbbcrp12:RPbbcrp00:RPbbcrp01:RPbbcrp02"; //29
...
//__________________________________________________
int MWGpico::FillSngmuonsNtpRun12CuAu(PHMuoTracksOut* &muo, TNtuple* sngmuons,  TNtuple* sngvtx)
{
  //=== event selection
  ...
  Float_t realtrigBBCLL1_narrowvtx		=  -999; // real trigger BBCLL1 narrow vtx
  Float_t realtrigBBCLL1_narrowvtxA     =  -999; // real trigger BBCLL1 narrow vtx copyA
  Float_t realtrigBBCLL1_narrowvtxB     =  -999; // real trigger BBCLL1 narrow vtx copyB
  Float_t realtrigBBCLL1_novtx		    =  -999; // real trigger BBCLL1 novtx
  ...
  { 
	  ...
	  //scaled triggers
	  if ( _trig_lvl1->get_lvl1_trigscaled()&0x00000002) realtrigBBCLL1=1;
	  if ( _trig_lvl1->get_lvl1_trigscaled()&0x00000004) realtrigBBCLL1_narrowvtx=1;
	  if ( _trig_lvl1->get_lvl1_trigscaled()&0x00000008) realtrigBBCLL1_narrowvtxA=1;
	  if ( _trig_lvl1->get_lvl1_trigscaled()&0x00000010) realtrigBBCLL1_narrowvtxB=1;
	  if ( _trig_lvl1->get_lvl1_trigscaled()&0x00000020) realtrigBBCLL1_novtx=1;
  ...
  */
  ...
  //Float_t delphi_RP	= -999;
  Float_t RPbbcrp10	= -999;
  Float_t RPbbcrp11	= -999;
  Float_t RPbbcrp12	= -999;
  Float_t RPbbcrp00	= -999;
  Float_t RPbbcrp01	= -999;
  Float_t RPbbcrp02	= -999;
  ...
  Evt_Data[14] = realtrigBBCLL1_narrowvtx;

  Evt_Data[15] = realtrigBBCLL1_narrowvtxA;
  Evt_Data[16] = realtrigBBCLL1_narrowvtxB;
  Evt_Data[17] = realtrigBBCLL1_novtx;
  Evt_Data[18] = livetrigBBCLL1;
  Evt_Data[19] = livetrigBBCLL1_narrowvtx;

  Evt_Data[20] = livetrigBBCLL1_narrowvtxA;
  Evt_Data[21] = livetrigBBCLL1_narrowvtxB;
  Evt_Data[22] = livetrigBBCLL1_novtx;

  Evt_Data[23] = RPbbcrp10;
  Evt_Data[24] = RPbbcrp11;
  Evt_Data[25] = RPbbcrp12;
  Evt_Data[26] = RPbbcrp00;
  Evt_Data[27] = RPbbcrp01;
  Evt_Data[28] = RPbbcrp02;

  /*
  Evt_Data[29] = sng_v2_N;
  Evt_Data[30] = sng_v2_S;
  Evt_Data[31] = sng_v2;
  */
  ...
  if (muo) { 
	...
	while( TMutTrkMap::const_pointer trk_ptr = trk_iter.next() )
	{
      ...
      varNT[42] = realtrigBBCLL1_narrowvtx; 
      varNT[43] = realtrigBBCLL1_narrowvtxA;
      varNT[44] = realtrigBBCLL1_narrowvtxB;

      varNT[45] = realtrigBBCLL1_novtx;
      varNT[46] = xSTI;
      ...
      varNT[53] = ySTIII;
      varNT[54] = zSTIII;
      varNT[55] = ref_vtx_rdca;           	   // muon px at Vertex
      varNT[56] = ref_vtx_r;            	   // muon py at Vertex

      varNT[57] = ref_vtx_z;                       // muon pz at Vertex
      varNT[58] = vertex.get_vtx_z();              // event Z-vtx from refit
      varNT[59] = Clock_trig;
      varNT[60] = realtrig_MB;                     // live real   trigger for MB
      varNT[61] = dANGLE;
      ...
      varNT[64] = dPHI;    
      varNT[65] = ROAD_SLOPE;
	  varNT[66] = vertex.get_chisquare();
	  varNT[67] = vertex.get_chisquare_pdf();
      ...
      varNT[74] = MC_N_PART; //
      varNT[75] = MC_PX; // from MC tracker_map
      varNT[76] = MC_PY; // from MC tracker_map
      varNT[77] = MC_PZ; // from MC tracker_map
      varNT[78] = MC_PTOT; // from MC tracker_map
      varNT[79] = MC_Z; // from MC tracker_map

      varNT[80] = MC_PID; // from MC tracker_map
      varNT[81] = MC_HITS; // hits of the major MC trk
      varNT[82] = MC_P_PID; // from MC tracker_map
      varNT[83] = MC_P_PX; // from MC tracker_map
      varNT[84] = MC_P_PY; // from MC tracker_map

      varNT[85] = MC_P_PZ; // from MC tracker_map
      varNT[86] = MC_P_PTOT; //
      varNT[87] = MC_P_Z; //
      varNT[88] = MC_D_PID; // from MC tracker_map for daughter particle
      varNT[89] = MC_D_PX; // from MC tracker_map

      varNT[90] = MC_D_PY; // from MC tracker_map
      varNT[91] = MC_D_PZ; // from MC tracker_map
      varNT[92] = MC_D_PTOT; //
      varNT[93] = MC_D_Z; // origin_z
      varNT[94] = MC_D_N; // total # of daughter particles

      varNT[95] = MC_X; // from MC tracker_map
      varNT[96] = MC_Y; // from MC tracker_map
      varNT[97] = MC_G_PID; // from MC tracker_map
      varNT[98] = MC_G_PX; // from MC tracker_map
      varNT[99] = MC_G_PY; // from MC tracker_map
	  
      varNT[100] = MC_G_PZ; // from MC tracker_map
      varNT[101] = MC_G_PTOT; //
      varNT[102] = MC_G_Z; //
      varNT[103] = MC_TRK;
      //      varNT[98] = dphi;

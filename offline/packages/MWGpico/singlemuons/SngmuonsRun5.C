// $Id: SngmuonsRun5.C,v 1.12 2014/12/09 06:28:10 rseidl Exp $
...
void MWGpico::BookSngmuonsNtupleRun5(TNtuple*& sngmuons, TString m_name, TString m_title)
{
...
void MWGpico::BookSngmuonsEvtNtupleRun5(TNtuple*& sngvtx, TString v_name, TString v_title )
{
...
//__________________________________________________
int MWGpico::FillSngmuonsNtpRun5(PHMuoTracksOut* &muo, TNtuple* sngmuons,  TNtuple* sngvtx)
{
  //=== event selection
  ...
  if(_trig_lvl1){ // Trigger Node exists in data file
    ...
    if (TrigHelp->didLevel1TriggerGetScaled("MUIDLL1_N1D&BBCLL1")) {
      realtrigN_1D=1;
    }
    if (TrigHelp->didLevel1TriggerGetScaled("MUIDLL1_S1S&BBCLL1")) {
      realtrigS_1S=1;
    }
    if (TrigHelp->didLevel1TriggerGetScaled("MUIDLL1_N1S&BBCLL1")) {
      realtrigN_1S=1;
    }
    
    // live triggers
    if (TrigHelp->didLevel1TriggerFire("MUIDLL1_S1D&BBCLL1")) {
      livetrigS_1D=1;
    }
    if (TrigHelp->didLevel1TriggerFire("MUIDLL1_N1D&BBCLL1")) {
      livetrigN_1D=1;
    }
    if (TrigHelp->didLevel1TriggerFire("MUIDLL1_S1S&BBCLL1")) {
      livetrigS_1S=1;
    }
    if (TrigHelp->didLevel1TriggerFire("MUIDLL1_N1S&BBCLL1")) {
      livetrigN_1S=1;
    }
    ...
    //
    // Get Trigger info from real data
    //
  
  if (_trig_lvl1){
    
    if (_trig_lvl1->get_lvl1_triglive()&0x00000004){
      realtrig_MB =2;
    }
    
    if ( _trig_lvl1->get_lvl1_trigscaled()&0x00000004){
      realtrig_MB =1;
    }
    
    if (_trig_lvl1->get_lvl1_triglive()&0x00000008){
      realtrig_MB =22;
    }
    
    if ( _trig_lvl1->get_lvl1_trigscaled()&0x00000008){
      realtrig_MB =11;
    }
  }// end (if _trig_lvl1)
  //------------//////////////////////////////

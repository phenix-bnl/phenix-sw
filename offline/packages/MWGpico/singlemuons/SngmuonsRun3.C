// $Id: SngmuonsRun3.C,v 1.11 2014/12/09 06:28:10 rseidl Exp $
...
void MWGpico::BookSngmuonsNtupleRun3(TNtuple*& sngmuons, TString m_name, TString m_title)
{
...
void MWGpico::BookSngmuonsEvtNtupleRun3(TNtuple*& sngvtx, TString v_name, TString v_title )
{
...
//__________________________________________________
int MWGpico::FillSngmuonsNtpRun3(PHMuoTracksOut* &muo, TNtuple* sngmuons,  TNtuple* sngvtx)
{
  //=== event selection
  ...
  { 
    ...
    for (int ipart=0; ipart<npart; ipart++) 
    {
      ...
      /*
      float xSTII = vertex.get_trk_x( 2 );
      float ySTII = vertex.get_trk_y( 2 );
      float zSTII = vertex.get_trk_z( 2 );

      float pxSTII =  vertex.get_px( 2 );
      float pySTII =  vertex.get_py( 2 );
      float pzSTII =  vertex.get_pz( 2 );
      */
      ...
      if( _choice == "simu" || _choice == "simu_file" ) { BbcZVertex = vertex.get_vtx_z(); }

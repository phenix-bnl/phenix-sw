#ifndef __TRIGRUNLVL2V2_H
#define __TRIGRUNLVL2V2_H
...
class TrigRunLvl2v2: public TrigRunLvl2
{
 public:
  TrigRunLvl2v2();
  virtual ~TrigRunLvl2v2() {}
  TrigRunLvl2v2(const TrigRunLvl2v2&);

  TrigRunLvl2v2* clone() const { return new TrigRunLvl2v2(*this); }
  ...
  void Reset();
   ...
   // *** lvl2_trig_name
   const char * get_lvl2_trig_name(const unsigned int i) const {return lvl2_trig_name[i].Data();}
...
private:
  void copyTo(TrigRunLvl2v2& o) const;
 ...
 protected:
   ...
   ClassDef(TrigRunLvl2v2,1)

};

#endif /*  __TRIGRUNLVL2V2_H */

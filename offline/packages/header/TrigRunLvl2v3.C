...
TrigRunLvl2v3::TrigRunLvl2v3(const TrigRunLvl2v3& o)
{
  o.copyTo(*this);
}

void
TrigRunLvl2v3::copyTo(TrigRunLvl2v3& o) const
{
...
int TrigRunLvl2v3::isValid() const
{
...
void TrigRunLvl2v3::identify(ostream& os) const
{
  os << "identify yourself: TrigRunLvl2v3 object" << endl;
  os << "Level2 Trigger Version: " << lvl2_version << endl;
  return ;
}

unsigned int
TrigRunLvl2v3::get_lvl1_lvl2_reject_enable(const unsigned int i) const
{
...
void
TrigRunLvl2v3::set_lvl1_lvl2_reject_enable(const unsigned int ival, const unsigned int i)
{
  if (ival == 0 || ival == 1)
    {

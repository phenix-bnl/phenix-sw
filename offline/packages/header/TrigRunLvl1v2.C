#include "TrigRunLvl1v2.h"
//INCLUDECHECKER: Removed this line: #include "phool.h"
#include <iostream>

ClassImp(TrigRunLvl1v2)

using namespace std;

const static unsigned int INIT_TRIGGER_VERSION = 9999999;

TrigRunLvl1v2::TrigRunLvl1v2()
{
  init();
  return ;
}

TrigRunLvl1v2::TrigRunLvl1v2(const TrigRunLvl1v2& o)
{
  o.copyTo(*this);
}

void
TrigRunLvl1v2::copyTo(TrigRunLvl1v2& o) const
{
...
int TrigRunLvl1v2::isValid() const
{
...
void TrigRunLvl1v2::identify(ostream& os) const
{
  os << "identify yourself: TrigRunLvl1v2 object" << endl;
  os << "Trigger Version: " << trigger_version << endl;
  return ;
}

const char *TrigRunLvl1v2::get_lvl1_trig_name_bybit(const unsigned int bit) const
{
...
unsigned int
TrigRunLvl1v2::get_lvl1_trigger_enable(const unsigned int i) const
{
...
unsigned int
TrigRunLvl1v2::get_lvl1_trigger_enable_bybit(const unsigned int bit) const
{
  int index = get_lvl1_trig_index(bit);
  if (index == 999)
    {
...
void
TrigRunLvl1v2::set_lvl1_trigger_enable(const unsigned int ival, const unsigned int i)
{
  if (ival == 0 || ival == 1)
    {
...
unsigned int
TrigRunLvl1v2::get_lvl1_trig_index(const unsigned int bit) const
{
...
unsigned int
TrigRunLvl1v2::get_lvl1_trig_scale_down_bybit(const unsigned int bit) const
{
  int index = get_lvl1_trig_index(bit);
  if (index == 999)
    {
...
unsigned int
TrigRunLvl1v2::get_lvl1_lvl2_reject_enable(const unsigned int i) const
{
...
unsigned int
TrigRunLvl1v2::get_lvl1_lvl2_reject_enable_bybit(const unsigned int bit) const
{
  int index = get_lvl1_trig_index(bit);
  if (index == 999)
    {
...
void
TrigRunLvl1v2::set_lvl1_lvl2_reject_enable(const unsigned int ival, const unsigned int i)
{
  if (ival == 0 || ival == 1)
    {

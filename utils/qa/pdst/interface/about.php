...
<tr>
	...
	<tr>
        ...
        <!--	<td><a href="dictionary.php">Dictionary</a></td> -->
        	...
        	<td><a href="about.php" style="color: #1E90FF">About</a></td>
	</tr>
        </table>
        </div>
        </td>
...
<div id="textwindow">
04/27/2005 - A fix made:

<ul>
<li>Now grants access previleges before updating to ensure all qa tables can be opened  (aka. No more crashing on brand new tables with limited permissions).</li>
</ul>
...
<div id="textwindow">
04/08/2005 - A another new feature and a change made:

<ul>
<li>Added portals to QA Forum webpage(s).</li>
<li>Neated up padding on plots.  Fixed cutoff labels.</li>
</ul>

 ...
 **********************************************************************
 *
 * $Id: SQLColumnPrivileges.c,v 1.1.1.2 2004/04/01 16:48:04 dave Exp $
 *
 * $Log: SQLColumnPrivileges.c,v $
 * Revision 1.1.1.2  2004/04/01 16:48:04  dave
 * import of v2.2.8
 *
...
static char const rcsid[]= "$RCSfile: SQLColumnPrivileges.c,v $ $Revision: 1.1.1.2 $";

 ...
 **********************************************************************
 *
 * $Id: SQLProcedures.c,v 1.1.1.2 2004/04/01 16:48:07 dave Exp $
 *
 * $Log: SQLProcedures.c,v $
 * Revision 1.1.1.2  2004/04/01 16:48:07  dave
 * import of v2.2.8
 *
...
static char const rcsid[]= "$RCSfile: SQLProcedures.c,v $ $Revision: 1.1.1.2 $";

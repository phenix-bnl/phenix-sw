 ...
 **********************************************************************
 *
 * $Id: SQLProcedureColumns.c,v 1.1.1.2 2004/04/01 16:48:06 dave Exp $
 *
 * $Log: SQLProcedureColumns.c,v $
 * Revision 1.1.1.2  2004/04/01 16:48:06  dave
 * import of v2.2.8
 *
...
static char const rcsid[]= "$RCSfile: SQLProcedureColumns.c,v $ $Revision: 1.1.1.2 $";

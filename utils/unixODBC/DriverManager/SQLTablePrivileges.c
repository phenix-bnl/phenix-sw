 ...
 **********************************************************************
 *
 * $Id: SQLTablePrivileges.c,v 1.1.1.2 2004/04/01 16:48:08 dave Exp $
 *
 * $Log: SQLTablePrivileges.c,v $
 * Revision 1.1.1.2  2004/04/01 16:48:08  dave
 * import of v2.2.8
 *
...
static char const rcsid[]= "$RCSfile: SQLTablePrivileges.c,v $ $Revision: 1.1.1.2 $";

 ...
 **********************************************************************
 *
 * $Id: SQLConnect.c,v 1.1.1.2 2004/04/01 16:48:05 dave Exp $
 *
 * $Log: SQLConnect.c,v $
 * Revision 1.1.1.2  2004/04/01 16:48:05  dave
 * import of v2.2.8
 *
...
static char const rcsid[]= "$RCSfile: SQLConnect.c,v $ $Revision: 1.1.1.2 $";
...
restart:;
    ...
    for( ptr = pool_head, prev = NULL; ptr; prev = ptr, ptr = ptr -> next )
    {
        ...
        if ( !has_checked && CHECK_SQLGETCONNECTOPTION(( &ptr -> connection )))
        {
            ...
            ret = SQLSETCONNECTOPTION(( &ptr->connection ),
                        ptr -> connection.driver_dbc,
                        SQL_ATTR_CONNECTION_DEAD,
                        &dead );

...
#
#
# Usage:  perl -w project93PISAPiPlus++.pl >& project93PISAPiPlus++.log & (change name of script as required)
...
# Note that the output location for the PISA hits files must be in your gpfs2 area made in the RUN6PRDFF directory
#
$myName = "maguire";   # your name
$topName = "/scratch/$myName/0/project93/pisaEvents/PiPlus/PosField/";    # top directory for this project's files
$pisaDone = "/gpfs2/RUN6PRDF/Run5/$myName/project93/pisaEvents/"; # destination directory for PISAEvent.root files
...
$eventsPerRun = 100000;  # number of events per run
$nCycle = 4; # 4 cycles with total of 100 jobs (100*100,000 = 10,000,000 events)

$oscProject = 93;   # project number
$oscVersion = 0;
$oscEvent = 95252;  # input event file ID number
$idBase = 95251;    # base PISA ID number for this event file

#
# Set up parts of input and output file names
#
$oscNameFirst = "PISA2000_PiPlus++-00000";  # name means pi+ in ++ field
$oscNameLast = "-00$oscProject.rootg";

#
# No need to change anything else below except the PBS wall clock and CPU times
#
$wallClockTime = "03:50:00"; # in hours:minutes:seconds, change as required
$cpuTime = "03:49:00";  # in hours:minutes:seconds, change as required and less than wallClockTime

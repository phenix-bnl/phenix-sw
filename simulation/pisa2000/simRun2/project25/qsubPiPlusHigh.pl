#!/usr/local/bin/perl
#
# Usage:  perl -w qsubPiPlusHigh.pl >& subPiPlusHigh.out &
#
$topName = "/mrbig/maguire/project25PiPlusHigh/";  # top directory for this project's files
...
$numberEnd = 25;
$numberPerCycle = 25;
$eventsPerRun = 22000;  # number of events per run
...
$idBase = 27800;  # base PISA ID number for this event file
$iCycleStart = 0;
$nCycle = 10;      # assume 10 cycles total of 25 jobs
...
for($number=$numberStart; $number<=$numberEnd; $number++) {
  ...
  for($iCycle=$iCycleStart; $iCycle<$nCycle; $iCycle++) {
    ...
    print FILE "#PBS -j oe\n";
    print FILE "#PBS -l walltime=08:00:00\n";
    print FILE "#PBS -l cput=06:00:00\n";

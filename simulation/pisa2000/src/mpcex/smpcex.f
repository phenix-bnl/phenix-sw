...
C=====================================================================
      subroutine run08_smpcex_container
C=====================================================================
C
...
C Front and back plate (use tube for now, even though inner region is square)
      ...
      call gsvolu('FPLT','TUBE',skin_nmed,plate_par,0,ivolu)
      call gsatt('FPLT','SEEN',1)
      call gsatt('FPLT','COLO',2)

      call gsvolu('BPLT','TUBE',skin_nmed,plate_par,0,ivolu)
      call gsatt('BPLT','SEEN',1)
      call gsatt('BPLT','COLO',2)
      ...
      call gsposp('FPLT',5,'MUA2',x,y,z,0,'ONLY',plate_par,3)

      z = z_backplate
      call gsposp('BPLT',6,'MUA2',x,y,z,0,'ONLY',plate_par,3)

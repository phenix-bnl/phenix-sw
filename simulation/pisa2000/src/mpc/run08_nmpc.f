c $Id: run08_nmpc.f,v 1.4 2011/03/17 04:18:56 lajoie Exp $

C=====================================================================
C    FILE NAME run08_mpc
C.   author : Mickey Chiu
C    July 16, 2007
C.   North Muon Piston Calorimeter Installed in Run08
C.   This differs only in the led system, which changes the z-location
C=====================================================================
      subroutine run08_nmpc
C=====================================================================
C
...
C.   author : Mickey Chiu
C=====================================================================
      subroutine run08_nmpc_container
C=====================================================================
C

C     File name: inr_gustep.f
C       ---------
      SUBROUTINE INR_GUSTEP
C     ====================================================================
c     Revision History:
c     """"""""""""""""
...
#include "guphnx.inc"
      ...
      INTEGER K
      INTEGER ITEST
      REAL HIT_ALL(15)  ! 15 refers to the MAXIMUM number of tracking
...
c     Store hits for charged particles, or if NEUT set in pisa.kumac file
     ...
     &        (CVOLU_OPT(5,3).EQ.'NEUT'.OR.CHARGE.NE.0.0))THEN
            ...
            IF(ITEST.EQ.0)THEN
               WRITE(6,999)ITEST
               STOP  ' PISA is stopping in INR_GUSTEP'
 ...
 999  FORMAT(/,' INR_GUSTEP <E>: failure in call to GSAHIT ',

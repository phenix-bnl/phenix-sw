#ifndef __PACKET_RXNP_FPGA_H__
#define __PACKET_RXNP_FPGA_H__
...
*/
#ifndef __CINT__
class WINDOWSEXPORT Packet_rxnp_fpga : public Packet_w4  {
#else
class  Packet_rxnp_fpga : public Packet_w4  {
#endif

public:
  Packet_rxnp_fpga(PACKET_ptr);

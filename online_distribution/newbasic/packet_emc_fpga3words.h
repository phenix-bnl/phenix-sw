#ifndef __PACKET_EMC_FPGA3WORDS_H__
#define __PACKET_EMC_FPGA3WORDS_H__
...
*/
#ifndef __CINT__
class WINDOWSEXPORT Packet_emc_fpga3words : public Packet_emc_fpga {
#else
class  Packet_emc_fpga3words : public Packet_emc_fpga {
#endif

public:
  Packet_emc_fpga3words(PACKET_ptr);

#ifndef __PACKET_EMC_OLDSTYLE_H__
#define __PACKET_EMC_OLDSTYLE_H__
...
*/
#ifndef __CINT__
class WINDOWSEXPORT Packet_emc_oldstyle : public Packet_w4 {
#else
class  Packet_emc_oldstyle : public Packet_w4 {
#endif

public:
  Packet_emc_oldstyle(PACKET_ptr);
  ~Packet_emc_oldstyle();
...
protected:
 ...
 Packet *the_real_packet;
 int is_a_fpga_packet;

};

#endif /* __PACKET_EMC_OLDSTYLE_H__ */

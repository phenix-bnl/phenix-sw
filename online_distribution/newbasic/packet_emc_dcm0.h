...
#ifndef __PACKET_EMC_DCM0_H__
#define __PACKET_EMC_DCM0_H__
...
*/
#ifndef __CINT__
class WINDOWSEXPORT Packet_emc_dcm0 : public Packet_emc {
#else
class  Packet_emc_dcm0 : public Packet_emc {
#endif

public:
  Packet_emc_dcm0(PACKET_ptr);

#ifndef __PACKET_mutc_fpgashort_H__
#define __PACKET_mutc_fpgashort_H__


#include <packet_w124.h>

/**
   This is the packet which deals with data in mutc_fpgashort format.
   It inherits from Packet\_w4 because the data are 32bit entities.
*/

#ifndef __CINT__
class WINDOWSEXPORT Packet_mutc_fpgashort : public Packet_w4{ 
#else
class  Packet_mutc_fpgashort : public Packet_w4 {
#endif

public:
  Packet_mutc_fpgashort(PACKET_ptr);
...
#endif /* __PACKET_mutc_fpgashort_H__ */

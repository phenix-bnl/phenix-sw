...
**   Date: $Date: 2010/09/21 19:37:50 $ 
** 
** $Log: packetRoutines.C,v $
** Revision 1.5  2010/09/21 19:37:50  phoncs
...
**
**  A pointer to the DWORD immediately following the "packet" (the header) is returned
*/
...
/*
**  Make an unstructured empty packet. a pointer to the DWORD following the empty
**  packet is returned
*/

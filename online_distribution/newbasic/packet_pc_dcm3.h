#ifndef __PACKET_PC_DCM3_H__
#define __PACKET_PC_DCM3_H__
...
*/
#ifndef __CINT__
class WINDOWSEXPORT Packet_pc_dcm3 : public Packet_w4 {
#else
class  Packet_pc_dcm3 : public Packet_w4 {
#endif

public:
  Packet_pc_dcm3(PACKET_ptr);

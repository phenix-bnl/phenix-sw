#ifndef __PACKET_ZDC_FPGA_H__
#define __PACKET_ZDC_FPGA_H__


#include <packet_w124.h>

/**
   This is the packet which deals with data in ZDC\_FPGA format.
   It inherits from Packet\_w4 because the data are 32bit entities.
*/
#ifndef __CINT__
class WINDOWSEXPORT Packet_zdc_fpga : public Packet_w4 {
#else
class  Packet_zdc_fpga : public Packet_w4 {
#endif

public:
  Packet_zdc_fpga();
  Packet_zdc_fpga(PACKET_ptr);
  ~Packet_zdc_fpga();
...
ZDC has charge information and two time infos. Charge is considered

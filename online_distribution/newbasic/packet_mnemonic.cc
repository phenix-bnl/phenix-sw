...
const char *get_mnemonic (const int structure, const int format)
{
  ...
  switch (format)
    ...
    case(IDMUTC_FPGANEWSUPV6): return "IDMUTC_FPGANEWSUPV6";
    ...
    case(IDRPC_PROTO): return "IDRPC_PROTO";
    case(IDRPC_PROTO0SUP): return "IDRPC_PROTO0SUP";
    ...
    case(IDHBD_FPGA3SAMPLES): return "IDHBD_FPGA3SAMPLES";
    case(IDHBD_FPGA3SAMPLES0SUP): return "IDHBD_FPGA3SAMPLES0SUP";

    case(IDRXNP_FPGASHORT): return "IDRXNP_FPGASHORT";
    case(IDRXNP_FPGASHORT0SUP): return "IDRXNP_FPGASHORT0SUP";

    case(IDVTXP_FPGA):     return "IDVTXP_FPGA";
    case(IDVTXS_FPGA):     return "IDVTXS_FPGA";
    case(IDFVTX_DCM0):     return "IDFVTX_DCM0";
    case(IDFVTX_SIM):      return "IDFVTX_SIM";
    case(IDMUTRIG_FPGA):   return "IDMUTRIG_FPGA";
    ...
    case (IDSTRIP_DCM0):    return "IDSTRIP_DCM0";
    case (IDMUTRG_DCM0):    return "IDMUTRG_DCM0";
    case (IDFOCAL_FPGATEST):    return "IDFOCAL_FPGATEST";
    case (IDMPCEX_FPGA):    return "IDMPCEXTEST_FPGA";
    case (IDMPCEX_FPGA0SUP):    return "IDMPCEXTEST_FPGA0SUP";

#ifndef __PACKET_MUTC_DCM3_H__
#define __PACKET_MUTC_DCM3_H__


#include <packet_w124.h>

/**
   This is the packet which deals with data in MUTC_DCM3 format.
   It inherits from Packet\_w4 because the data are 32bit entities.
*/
#ifndef __CINT__
class WINDOWSEXPORT Packet_mutc_dcm3 : public Packet_w4 {
#else
class  Packet_mutc_dcm3 : public Packet_w4 {
#endif

public:
  Packet_mutc_dcm3(PACKET_ptr);

#ifndef __PACKET_hbd_fpga3samples_H__
#define __PACKET_hbd_fpga3samples_H__


#include <packet_w124.h>

/**
   This is the packet which deals with data in hbd_fpga3samples format.
   It inherits from Packet\_w4 because the data are 32bit entities.
*/

#ifndef __CINT__
class WINDOWSEXPORT Packet_hbd_fpga3samples : public Packet_w4{ 
#else
class  Packet_hbd_fpga3samples : public Packet_w4 {
#endif

public:
  Packet_hbd_fpga3samples(PACKET_ptr);
...
#endif /* __PACKET_hbd_fpga3samples_H__ */

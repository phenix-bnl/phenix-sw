#ifndef __PACKET_NTCT0_FPGA_H__
#define __PACKET_NTCT0_FPGA_H__


#include <packet_w124.h>

/**
   This is the packet which deals with data in NTCT0 format.
   It inherits from Packet\_w4 because the data are 32bit entities.
*/
#ifndef __CINT__
class WINDOWSEXPORT Packet_ntct0_fpga : public Packet_w4 {
#else
class  Packet_ntct0_fpga : public Packet_w4 {
#endif

public:
  Packet_ntct0_fpga();
  Packet_ntct0_fpga(PACKET_ptr);
  ~Packet_ntct0_fpga();

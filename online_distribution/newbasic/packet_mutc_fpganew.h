#ifndef __PACKET_mutc_fpganew_H__
#define __PACKET_mutc_fpganew_H__


#include <packet_w124.h>

/**
   This is the packet which deals with data in mutc_fpganew format.
   It inherits from Packet\_w4 because the data are 32bit entities.
*/

#ifndef __CINT__
class WINDOWSEXPORT Packet_mutc_fpganew : public Packet_w4{ 
#else
class  Packet_mutc_fpganew : public Packet_w4 {
#endif

public:
  Packet_mutc_fpganew(PACKET_ptr);
...
#endif /* __PACKET_mutc_fpganew_H__ */
